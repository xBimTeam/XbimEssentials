			...
			try
			{
				switch (clause)
				{
					case IfcStructuralPlanarActionClause.SuitableLoadType:
						retVal = Functions.SIZEOF(Functions.NewTypesArray("IFCSTRUCTURALLOADPLANARFORCE", "IFCSTRUCTURALLOADTEMPERATURE") * Functions.TYPEOF(this/* as IfcStructuralActivity*/.AppliedLoad)) == 1;
						break;
				...
				var log = Validation.ValidationLogging.CreateLogger<Xbim.IfcRail.StructuralAnalysisDomain.IfcStructuralPlanarAction>();
