			...
			try
			{
				switch (clause)
				{
					case IfcStructuralLinearActionClause.SuitableLoadType:
						retVal = Functions.SIZEOF(Functions.NewTypesArray("IFCSTRUCTURALLOADLINEARFORCE", "IFCSTRUCTURALLOADTEMPERATURE") * Functions.TYPEOF(this/* as IfcStructuralActivity*/.AppliedLoad)) == 1;
						break;
				...
				var log = Validation.ValidationLogging.CreateLogger<Xbim.IfcRail.StructuralAnalysisDomain.IfcStructuralLinearAction>();
