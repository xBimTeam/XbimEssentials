			...
			try
			{
				switch (clause)
				{
					case IfcArbitraryOpenProfileDefClause.WR11:
						retVal = (Functions.TYPEOF(this).Contains("IFCCENTERLINEPROFILEDEF")) || (this/* as IfcProfileDef*/.ProfileType == IfcProfileTypeEnum.CURVE);
						break;
				...
				var log = Validation.ValidationLogging.CreateLogger<Xbim.IfcRail.ProfileResource.IfcArbitraryOpenProfileDef>();
