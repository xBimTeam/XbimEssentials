			...
			try
			{
				switch (clause)
				{
					...
					case IfcProjectClause.CorrectContext:
						retVal = !(Functions.EXISTS(this/* as IfcContext*/.RepresentationContexts)) || (Functions.SIZEOF(this/* as IfcContext*/.RepresentationContexts.Where(Temp => Functions.TYPEOF(Temp).Contains("IFCGEOMETRICREPRESENTATIONSUBCONTEXT"))) == 0);
						break;
				...
				var log = Validation.ValidationLogging.CreateLogger<Xbim.IfcRail.Kernel.IfcProject>();
