			...
			try
			{
				switch (clause)
				{
					case IfcTopologyRepresentationClause.WR21:
						retVal = Functions.SIZEOF(this/* as IfcRepresentation*/.Items.Where(temp => !(Functions.TYPEOF(temp).Contains("IFCTOPOLOGICALREPRESENTATIONITEM")))) == 0;
						break;
				...
				var log = Validation.ValidationLogging.CreateLogger<Xbim.IfcRail.RepresentationResource.IfcTopologyRepresentation>();
