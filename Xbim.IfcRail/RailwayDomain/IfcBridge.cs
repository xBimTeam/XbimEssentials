...
namespace Xbim.IfcRail.RailwayDomain
{
	...
	public  partial class @IfcBridge : IfcFacility, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcBridge>
	{
		...
		internal IfcBridge(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 8: 
					...
					return;
				case 9: 
                    _predefinedType = (IfcBridgeTypeEnum) System.Enum.Parse(typeof (IfcBridgeTypeEnum), value.EnumVal, true);
					return;
				default:
