...
{
	[ExpressType("IfcRailway", 1371)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcRailway : IfcFacility, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcRailway>
	{

		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcRailway(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 8: 
					...
					return;
				case 9: 
                    _predefinedType = (IfcRailwayTypeEnum) System.Enum.Parse(typeof (IfcRailwayTypeEnum), value.EnumVal, true);
					return;
				default:
