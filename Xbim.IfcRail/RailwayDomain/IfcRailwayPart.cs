...
{
	[ExpressType("IfcRailwayPart", 1373)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcRailwayPart : IfcFacilityPart, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcRailwayPart>
	{

		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcRailwayPart(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 8: 
					...
					return;
				case 9: 
                    _predefinedType = (IfcRailwayPartTypeEnum) System.Enum.Parse(typeof (IfcRailwayPartTypeEnum), value.EnumVal, true);
					return;
				default:
