...
{
	public partial class IfcLibraryInformationTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{2, 3, 4};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCLIBRARYINFORMATION";} }
