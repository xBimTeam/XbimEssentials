...
{
	public partial class IfcElectricDistributionPointTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{8, 9};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCELECTRICDISTRIBUTIONPOINT";} }
