...
{
	public partial class IfcInventoryTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{8, 5};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCINVENTORY";} }
