...
{
	public partial class IfcCostValueTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{4, 5, 6, 6, 6};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCCOSTVALUE";} }
