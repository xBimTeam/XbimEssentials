...
{
	public partial class IfcSubContractResourceTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{8, 5, 5, 6, 7, 9, 10, 10, 10};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCSUBCONTRACTRESOURCE";} }
