...
{
	public partial class IfcDocumentInformationTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{10, 11, 12, 13, 14, 0, 0, 3};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCDOCUMENTINFORMATION";} }
