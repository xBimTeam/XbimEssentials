...
{
	public partial class IfcBoundaryNodeConditionWarpingTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{4, 5, 6, 7, 1, 2, 3};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCBOUNDARYNODECONDITIONWARPING";} }
