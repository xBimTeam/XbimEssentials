...
{
	public partial class IfcRelDefinesByPropertiesTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{5};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCRELDEFINESBYPROPERTIES";} }
