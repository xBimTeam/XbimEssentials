...
{
	public partial class IfcProcedureTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{5, 5, 6, 6, 6, 7};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCPROCEDURE";} }
