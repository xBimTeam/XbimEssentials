...
{
	public partial class IfcObjectiveTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{5, 7, 8};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCOBJECTIVE";} }
