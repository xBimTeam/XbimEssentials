...
{
	public partial class IfcMaterialClassificationRelationshipTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{0};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCMATERIALCLASSIFICATIONRELATIONSHIP";} }
