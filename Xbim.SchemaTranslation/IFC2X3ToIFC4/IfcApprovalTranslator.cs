...
{
	public partial class IfcApprovalTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{0, 5, 6, 1, 2, 3, 4, 4};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCAPPROVAL";} }
