...
{
	public partial class IfcRelAssociatesConstraintTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{4};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCRELASSOCIATESCONSTRAINT";} }
