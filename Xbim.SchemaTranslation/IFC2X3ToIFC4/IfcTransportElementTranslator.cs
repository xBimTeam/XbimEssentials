...
{
	public partial class IfcTransportElementTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{8, 8, 8, 9, 10};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCTRANSPORTELEMENT";} }
