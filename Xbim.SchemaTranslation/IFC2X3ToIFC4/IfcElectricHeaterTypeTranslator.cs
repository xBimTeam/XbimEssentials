...
{
	public partial class IfcElectricHeaterTypeTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{9};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCELECTRICHEATERTYPE";} }
