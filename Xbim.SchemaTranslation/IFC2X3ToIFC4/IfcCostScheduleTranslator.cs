...
{
	public partial class IfcCostScheduleTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{7, 8, 10, 12, 5, 6, 9, 11, 11, 11};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCCOSTSCHEDULE";} }
