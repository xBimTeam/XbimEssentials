...
{
	public partial class IfcRelOverridesPropertiesTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{5, 6};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCRELOVERRIDESPROPERTIES";} }
