...
{
	public partial class IfcPropertyDependencyRelationshipTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{0, 1, 2, 3};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCPROPERTYDEPENDENCYRELATIONSHIP";} }
