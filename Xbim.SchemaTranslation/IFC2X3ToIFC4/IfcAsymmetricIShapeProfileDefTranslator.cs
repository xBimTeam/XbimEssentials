...
{
	public partial class IfcAsymmetricIShapeProfileDefTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{3, 6, 7, 11};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCASYMMETRICISHAPEPROFILEDEF";} }
