...
{
	public partial class IfcWorkScheduleTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{6, 9, 10, 11, 12, 5, 5, 5, 13, 14, 14};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCWORKSCHEDULE";} }
