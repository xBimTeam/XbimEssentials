...
{
	public partial class IfcStructuralSteelProfilePropertiesTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCSTRUCTURALSTEELPROFILEPROPERTIES";} }
