...
{
	public partial class IfcRelConnectsPathElementsTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{7, 8};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCRELCONNECTSPATHELEMENTS";} }
