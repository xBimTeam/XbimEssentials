...
{
	public partial class IfcRelAssignsToResourceTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{6};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCRELASSIGNSTORESOURCE";} }
