...
{
	public partial class IfcTextureCoordinateGeneratorTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{0, 1};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCTEXTURECOORDINATEGENERATOR";} }
