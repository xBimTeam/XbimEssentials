...
{
	public partial class IfcTextStyleTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{1, 2};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCTEXTSTYLE";} }
