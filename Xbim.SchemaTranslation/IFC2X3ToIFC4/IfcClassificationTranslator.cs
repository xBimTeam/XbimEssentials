...
{
	public partial class IfcClassificationTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{2};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCCLASSIFICATION";} }
