...
{
	public partial class IfcStructuralLinearActionVaryingTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{11, 10, 12, 13};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCSTRUCTURALLINEARACTIONVARYING";} }
