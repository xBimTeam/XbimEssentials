...
{
	public partial class IfcRelAssociatesProfilePropertiesTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{4, 5, 6, 7};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCRELASSOCIATESPROFILEPROPERTIES";} }
