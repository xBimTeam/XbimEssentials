...
{
	public partial class IfcBlobTextureTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{4, 5, 2};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCBLOBTEXTURE";} }
