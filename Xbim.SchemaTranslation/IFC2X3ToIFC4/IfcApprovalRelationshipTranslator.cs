...
{
	public partial class IfcApprovalRelationshipTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{1, 2, 3, 0};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCAPPROVALRELATIONSHIP";} }
