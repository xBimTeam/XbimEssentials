...
{
	public partial class IfcOrderActionTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{6, 7, 8, 9, 5, 5, 10, 10};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCORDERACTION";} }
