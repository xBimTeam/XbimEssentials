...
{
	public partial class IfcStructuralSurfaceMemberVaryingTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{7, 9, 10};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCSTRUCTURALSURFACEMEMBERVARYING";} }
