...
{
	public partial class IfcStructuralPlanarActionTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{11, 10};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCSTRUCTURALPLANARACTION";} }
