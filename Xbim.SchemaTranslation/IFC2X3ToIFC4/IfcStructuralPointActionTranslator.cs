...
{
	public partial class IfcStructuralPointActionTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{10};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCSTRUCTURALPOINTACTION";} }
