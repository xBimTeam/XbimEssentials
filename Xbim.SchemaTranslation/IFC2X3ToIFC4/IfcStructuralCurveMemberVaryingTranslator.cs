...
{
	public partial class IfcStructuralCurveMemberVaryingTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{7};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCSTRUCTURALCURVEMEMBERVARYING";} }
