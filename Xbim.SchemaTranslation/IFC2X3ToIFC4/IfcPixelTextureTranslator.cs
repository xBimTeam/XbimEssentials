...
{
	public partial class IfcPixelTextureTranslator : ITranslator
	{
		private readonly int[] _translatesProperties = new int[]{4, 5, 6, 7, 2};
		
		public string OriginalSchema { get { return "IFC2X3";} }
		public string TranslatesEntity { get { return "IFCPIXELTEXTURE";} }
