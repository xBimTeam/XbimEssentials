...
(\'\\X[24]?\\)[0-9A-F]*(\\X0\\\') { if (!comment) { SetValue();  return((int)Tokens.STRING); } }
[\']([\n]|[\000\011-\046\050-\176\201-\237\240-\377]|[\047][\047]|[^\\][^X][^0](\\\'))*[\'] { if (!comment) { SetValue();  return((int)Tokens.STRING); } }
