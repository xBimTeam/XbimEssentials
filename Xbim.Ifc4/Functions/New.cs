...
namespace Xbim.Ifc4.Functions
{
    ...
    internal class New
    {
        internal static Direction Direction(double x, double y, double z)
        {
            return new Direction(x, y, z);
        }

        internal static Direction Direction(double x, double y)
        {
            return new Direction(x, y);
        }

        public static Vector Vector(Direction direction, double mod)
        {
            return new Vector(direction, mod);
        }

        public static Vector Vector(IIfcDirection direction, double mod)
        {
            return new Vector(new Direction(direction), mod);
        }

        public static DimensionalExponents DimensionalExponents(int len, int mass, int time, int elec, int temp, int substance, int lum)
        {
