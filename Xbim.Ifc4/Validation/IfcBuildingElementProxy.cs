...
namespace Xbim.Ifc4.SharedBldgElements
{
	public partial class IfcBuildingElementProxy : IExpressValidatable
	{
		...
		/// <summary>
		/// Tests the express where clause HasObjectName
		/// </summary>
		...
		public bool HasObjectName() {
			...
			try {
				...
				Log.Error($"Exception thrown evaluating where-clause 'HasObjectName' for #{EntityLabel}.", ex);
			}
			return retVal;
		}
		...
		public new IEnumerable<ValidationResult> Validate()
		{
			...
			if (!HasObjectName())
				yield return new ValidationResult() { Item = this, IssueSource = "HasObjectName", IssueType = ValidationFlags.EntityWhereClauses };
