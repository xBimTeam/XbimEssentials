...
namespace Xbim.Ifc4.ConstructionMgmtDomain
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc4.ConstructionMgmtDomain.IfcCrewResourceType");
		...
		public bool ValidateClause(Where.IfcCrewResourceType clause) {
			...
			if (clause == Where.IfcCrewResourceType.CorrectPredefinedType) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcCrewResourceType.CorrectPredefinedType' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
