...
{
    [ExpressType("IfcAlignment2DVerSegParabolicArc", 9008)]
    // ReSharper disable once PartialTypeWithSinglePart
    public partial class @IfcAlignment2DVerSegParabolicArc : IfcAlignment2DVerticalSegment, IIfcAlignment2DVerSegParabolicArc, IEquatable<@IfcAlignment2DVerSegParabolicArc>
    {
        ...
        public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
        {
            switch (propIndex)
            {
                ...
                case 6:
                    ...
                    return;
                case 7:
                    _parabolaConstant = (IfcPositiveLengthMeasure)(value.NumberVal);
                    return;
                case 8:
                    _isConvex = (IfcBoolean)(value.BooleanVal);
                    return;
                default:
