...
namespace Xbim.Ifc4x3.RoadDomain
{
	...
	public  partial class @IfcRoad : IfcFacility, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcRoad>
	{

		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcRoad(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 8: 
					...
					return;
				case 9: 
                    _predefinedType = (IfcRoadTypeEnum) System.Enum.Parse(typeof (IfcRoadTypeEnum), value.EnumVal, true);
					return;
				default:
