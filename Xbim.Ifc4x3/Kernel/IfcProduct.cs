...
namespace Xbim.Ifc4x3.Kernel
{
	...
	public abstract partial class @IfcProduct : IfcObject, IfcProductSelect, IfcSpatialReferenceSelect, IEquatable<@IfcProduct>
	{
		...
		{ 
			get 
			{
				return Model.Instances.Where<IfcRelPositions>(e => e.RelatedProducts != null &&  e.RelatedProducts.Contains(this), "RelatedProducts", this);
			} 
		}
