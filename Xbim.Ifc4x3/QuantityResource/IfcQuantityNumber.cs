...
namespace Xbim.Ifc4x3.QuantityResource
{
	...
	public  partial class @IfcQuantityNumber : IfcPhysicalSimpleQuantity, IInstantiableEntity, IContainsEntityReferences, IEquatable<@IfcQuantityNumber>
	{

		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcQuantityNumber(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		{ 
			get 
			{
				if(_activated) return _numberValue;
				Activate();
				return _numberValue;
			} 
			set
			{
				SetValue( v =>  _numberValue = v, _numberValue, value,  "NumberValue", 4);
			} 
		}	
