...
namespace Xbim.Ifc4x3.GeometryResource
{
	...
	public  partial class @IfcSineSpiral : IfcSpiral, IInstantiableEntity, IContainsEntityReferences, IEquatable<@IfcSineSpiral>
	{

		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcSineSpiral(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		{ 
			get 
			{
				if(_activated) return _sineTerm;
				Activate();
				return _sineTerm;
			} 
			set
			{
				SetValue( v =>  _sineTerm = v, _sineTerm, value,  "SineTerm", 2);
			} 
		}	
