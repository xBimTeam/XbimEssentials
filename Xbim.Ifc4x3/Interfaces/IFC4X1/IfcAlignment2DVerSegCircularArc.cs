...
namespace Xbim.Ifc4x3.GeometricConstraintResource
{
	public partial class @IfcAlignment2DVerSegCircularArc : IIfcAlignment2DVerSegCircularArc
	{
		...
		[CrossSchemaAttribute(typeof(IIfcAlignment2DVerSegCircularArc), 4)]
		...
		[CrossSchemaAttribute(typeof(IIfcAlignment2DVerSegCircularArc), 5)]
		...
		[CrossSchemaAttribute(typeof(IIfcAlignment2DVerSegCircularArc), 6)]
		...
		[CrossSchemaAttribute(typeof(IIfcAlignment2DVerSegCircularArc), 7)]
		...
		[CrossSchemaAttribute(typeof(IIfcAlignment2DVerSegCircularArc), 1)]
		...
		[CrossSchemaAttribute(typeof(IIfcAlignment2DVerSegCircularArc), 2)]
		...
		[CrossSchemaAttribute(typeof(IIfcAlignment2DVerSegCircularArc), 3)]
		...
		{ 
			get
			{
				return Model.Instances.Where<IIfcStyledItem>(e => (e.Item as IfcAlignment2DVerSegCircularArc) == this, "Item", this);
			} 
		}
	//## Custom code
	//##
