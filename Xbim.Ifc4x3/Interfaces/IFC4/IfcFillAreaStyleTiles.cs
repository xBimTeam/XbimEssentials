	...
	public partial class @IfcFillAreaStyleTiles : IIfcFillAreaStyleTiles
	{
		...
		{ 
			get
			{
				...
				return new Common.Collections.ProxyItemSet<GeometryResource.IfcVector, IIfcVector>(TilingPattern);
			} 
		}
		...
		{ 
			get
			{
				...
				return new Common.Collections.ProxyItemSet<IfcStyledItem, IIfcStyledItem>(Tiles);
			} 
		}
