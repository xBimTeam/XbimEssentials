...
{
	public partial class @IfcConstructionMaterialResourceType : IIfcConstructionMaterialResourceType
	{

		[CrossSchemaAttribute(typeof(IIfcConstructionMaterialResourceType), 12)]
		Ifc4.Interfaces.IfcConstructionMaterialResourceTypeEnum IIfcConstructionMaterialResourceType.PredefinedType 
		{ 
			get
			{
