	...
	public partial class @IfcBooleanResult : IIfcBooleanResult
	{
		...
		{ 
			get
			{
				...
				var ifctessellatedfaceset = FirstOperand as IfcTessellatedFaceSet;
			...
			set
			{
				...
				var ifctessellatedfaceset = value as IfcTessellatedFaceSet;
				if (ifctessellatedfaceset != null) 
				{
		...
		{ 
			get
			{
				...
				if (ifcsolidmodel != null) 
					return ifcsolidmodel;
				var ifctessellatedfaceset = SecondOperand as IfcTessellatedFaceSet;
				if (ifctessellatedfaceset != null) 
					return ifctessellatedfaceset;
				return null;
			} 
