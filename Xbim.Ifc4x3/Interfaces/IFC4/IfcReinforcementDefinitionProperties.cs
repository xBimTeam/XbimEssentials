	...
	public partial class @IfcReinforcementDefinitionProperties : IIfcReinforcementDefinitionProperties
	{
		...
		{ 
			get
			{
				...
				return new Common.Collections.ProxyItemSet<ProfileResource.IfcSectionReinforcementProperties, IIfcSectionReinforcementProperties>(ReinforcementSectionDefinitions);
			} 
		}
	//## Custom code
	//##
