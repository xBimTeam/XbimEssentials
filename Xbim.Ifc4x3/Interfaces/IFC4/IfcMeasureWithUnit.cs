		...
		{ 
			get
			{
				...
				if (ValueComponent is IfcAreaDensityMeasure) 
					return new Ifc4.MeasureResource.IfcAreaDensityMeasure((IfcAreaDensityMeasure)ValueComponent);
				...
				if (ValueComponent is IfcSoundPowerLevelMeasure) 
					return new Ifc4.MeasureResource.IfcSoundPowerMeasure((IfcSoundPowerLevelMeasure)ValueComponent);
				...
				if (ValueComponent is IfcSoundPressureLevelMeasure) 
					return new Ifc4.MeasureResource.IfcSoundPressureMeasure((IfcSoundPressureLevelMeasure)ValueComponent);
				...
				if (ValueComponent is IfcTemperatureRateOfChangeMeasure) 
					return new Ifc4.MeasureResource.IfcTemperatureRateOfChangeMeasure((IfcTemperatureRateOfChangeMeasure)ValueComponent);
				...
				if (ValueComponent is IfcNonNegativeLengthMeasure) 
					return new Ifc4.MeasureResource.IfcNonNegativeLengthMeasure((IfcNonNegativeLengthMeasure)ValueComponent);
				...
				if (ValueComponent is IfcBinary) 
					return new Ifc4.MeasureResource.IfcBinary((IfcBinary)ValueComponent);
				if (ValueComponent is IfcBoolean) 
					return new Ifc4.MeasureResource.IfcBoolean((IfcBoolean)ValueComponent);
				if (ValueComponent is DateTimeResource.IfcDate) 
					return new Ifc4.DateTimeResource.IfcDate((DateTimeResource.IfcDate)ValueComponent);
				if (ValueComponent is DateTimeResource.IfcDateTime) 
					return new Ifc4.DateTimeResource.IfcDateTime((DateTimeResource.IfcDateTime)ValueComponent);
				if (ValueComponent is DateTimeResource.IfcDuration) 
					return new Ifc4.DateTimeResource.IfcDuration((DateTimeResource.IfcDuration)ValueComponent);
				...
				if (ValueComponent is IfcPositiveInteger) 
					return new Ifc4.MeasureResource.IfcPositiveInteger((IfcPositiveInteger)ValueComponent);
				...
				if (ValueComponent is DateTimeResource.IfcTime) 
			...
			set
			{
				...
				{
					ValueComponent = new IfcAreaDensityMeasure((Ifc4.MeasureResource.IfcAreaDensityMeasure)value);
					if (_valueComponent4 != null)
						SetValue(v => _valueComponent4 = v, _valueComponent4, null, "ValueComponent", -1);
					return;
				}
				...
				{
					ValueComponent = new IfcTemperatureRateOfChangeMeasure((Ifc4.MeasureResource.IfcTemperatureRateOfChangeMeasure)value);
					if (_valueComponent4 != null)
						SetValue(v => _valueComponent4 = v, _valueComponent4, null, "ValueComponent", -1);
					return;
				}
				...
				{
					ValueComponent = new IfcNonNegativeLengthMeasure((Ifc4.MeasureResource.IfcNonNegativeLengthMeasure)value);
					if (_valueComponent4 != null)
						SetValue(v => _valueComponent4 = v, _valueComponent4, null, "ValueComponent", -1);
					return;
				}
				...
				{
					ValueComponent = new IfcBinary((Ifc4.MeasureResource.IfcBinary)value);
					if (_valueComponent4 != null)
						SetValue(v => _valueComponent4 = v, _valueComponent4, null, "ValueComponent", -1);
					return;
				}
				...
				{
					ValueComponent = new DateTimeResource.IfcDate((Ifc4.DateTimeResource.IfcDate)value);
					if (_valueComponent4 != null)
						SetValue(v => _valueComponent4 = v, _valueComponent4, null, "ValueComponent", -1);
					return;
				}
				...
				{
					ValueComponent = new DateTimeResource.IfcDateTime((Ifc4.DateTimeResource.IfcDateTime)value);
					if (_valueComponent4 != null)
						SetValue(v => _valueComponent4 = v, _valueComponent4, null, "ValueComponent", -1);
					return;
				}
				...
				{
					ValueComponent = new DateTimeResource.IfcDuration((Ifc4.DateTimeResource.IfcDuration)value);
					if (_valueComponent4 != null)
						SetValue(v => _valueComponent4 = v, _valueComponent4, null, "ValueComponent", -1);
					return;
				}
				...
				{
					ValueComponent = new IfcPositiveInteger((Ifc4.MeasureResource.IfcPositiveInteger)value);
					if (_valueComponent4 != null)
						SetValue(v => _valueComponent4 = v, _valueComponent4, null, "ValueComponent", -1);
					return;
				}
				...
				{
					ValueComponent = new DateTimeResource.IfcTime((Ifc4.DateTimeResource.IfcTime)value);
					if (_valueComponent4 != null)
						SetValue(v => _valueComponent4 = v, _valueComponent4, null, "ValueComponent", -1);
					return;
				}
				...
				{
					ValueComponent = new DateTimeResource.IfcTimeStamp((Ifc4.DateTimeResource.IfcTimeStamp)value);
					if (_valueComponent4 != null)
						SetValue(v => _valueComponent4 = v, _valueComponent4, null, "ValueComponent", -1);
					return;
				}
