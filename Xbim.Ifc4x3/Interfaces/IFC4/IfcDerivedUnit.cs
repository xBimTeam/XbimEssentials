...
namespace Xbim.Ifc4x3.MeasureResource
{
	public partial class @IfcDerivedUnit : IIfcDerivedUnit
	{
		...
		{ 
			get
			{
				...
				switch (UnitType)
				{
					...
					case IfcDerivedUnitEnum.AREADENSITYUNIT:
						return Ifc4.Interfaces.IfcDerivedUnitEnum.AREADENSITYUNIT;
					...
					case IfcDerivedUnitEnum.SOUNDPOWERLEVELUNIT:
						return Ifc4.Interfaces.IfcDerivedUnitEnum.SOUNDPOWERLEVELUNIT;
					case IfcDerivedUnitEnum.SOUNDPOWERUNIT:
						return Ifc4.Interfaces.IfcDerivedUnitEnum.SOUNDPOWERUNIT;
					case IfcDerivedUnitEnum.SOUNDPRESSURELEVELUNIT:
						return Ifc4.Interfaces.IfcDerivedUnitEnum.SOUNDPRESSURELEVELUNIT;
					...
					case IfcDerivedUnitEnum.TEMPERATURERATEOFCHANGEUNIT:
						return Ifc4.Interfaces.IfcDerivedUnitEnum.TEMPERATURERATEOFCHANGEUNIT;
		...
		private static string GetName(IfcUnit ifcUnit)
		{
			...
			return monetaryUnit != null ? monetaryUnit.Currency.ToString() : string.Empty;
		}
