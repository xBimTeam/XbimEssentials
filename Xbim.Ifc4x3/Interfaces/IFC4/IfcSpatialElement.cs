...
{
	public partial class @IfcSpatialElement : IIfcSpatialElement
	{
		...
		{ 
			get
			{
				return Model.Instances.Where<IIfcRelContainedInSpatialStructure>(e => (e.RelatingStructure as IfcSpatialElement) == this, "RelatingStructure", this);
			} 
		}
		...
		{ 
			get
			{
				return Model.Instances.Where<IIfcRelReferencedInSpatialStructure>(e => (e.RelatingStructure as IfcSpatialElement) == this, "RelatingStructure", this);
			} 
		}
	//## Custom code
	//##
