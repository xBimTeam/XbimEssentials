...
{
	[ExpressType("IfcAlignment2DCantSegTransition", 1399)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcAlignment2DCantSegTransition : IfcAlignment2DCantSegment, IInstantiableEntity, IEquatable<@IfcAlignment2DCantSegTransition>
	{

		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcAlignment2DCantSegTransition(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		{ 
			...
			set
			{
				SetValue( v =>  _startRadius = v, _startRadius, value,  "StartRadius", 10);
			} 
		}	
		...
		{ 
			...
			set
			{
				SetValue( v =>  _endRadius = v, _endRadius, value,  "EndRadius", 11);
			} 
		}	
		[EntityAttribute(12, EntityAttributeState.Mandatory, EntityAttributeType.None, EntityAttributeType.None, null, null, 15)]
		...
		{ 
			...
			set
			{
				SetValue( v =>  _isStartRadiusCCW = v, _isStartRadiusCCW, value,  "IsStartRadiusCCW", 12);
			} 
		}	
		[EntityAttribute(13, EntityAttributeState.Mandatory, EntityAttributeType.None, EntityAttributeType.None, null, null, 16)]
		...
		{ 
			...
			set
			{
				SetValue( v =>  _isEndRadiusCCW = v, _isEndRadiusCCW, value,  "IsEndRadiusCCW", 13);
			} 
		}	
		...
		{ 
			...
			set
			{
				SetValue( v =>  _transitionCurveType = v, _transitionCurveType, value,  "TransitionCurveType", 14);
			} 
		}	
		#endregion
        ...
        public bool Equals(@IfcAlignment2DCantSegTransition other)
	    {
	        return this == other;
	    }
        #endregion
