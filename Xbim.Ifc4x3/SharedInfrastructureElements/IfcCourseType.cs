...
namespace Xbim.Ifc4x3.SharedInfrastructureElements
{
	...
	public  partial class @IfcCourseType : IfcBuiltElementType, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcCourseType>
	{
		...
		internal IfcCourseType(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 8: 
					...
					return;
				case 9: 
                    _predefinedType = (IfcCourseTypeEnum) System.Enum.Parse(typeof (IfcCourseTypeEnum), value.EnumVal, true);
					return;
				default:
