...
namespace Xbim.Ifc4x3.SharedInfrastructureElements
{
	...
	public  partial class @IfcReinforcedSoil : IfcEarthworksElement, IInstantiableEntity, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcReinforcedSoil>
	{
		...
		internal IfcReinforcedSoil(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
                    _predefinedType = (IfcReinforcedSoilTypeEnum) System.Enum.Parse(typeof (IfcReinforcedSoilTypeEnum), value.EnumVal, true);
					return;
				default:
