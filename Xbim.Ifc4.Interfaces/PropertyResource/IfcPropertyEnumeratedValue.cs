...
namespace Xbim.Ifc4.Interfaces.PropertyResource
{
	...
	public  partial class @IfcPropertyEnumeratedValue : IfcSimpleProperty, IInstantiableEntity, IIfcPropertyEnumeratedValue, IEqualityComparer<@IfcPropertyEnumeratedValue>, IEquatable<@IfcPropertyEnumeratedValue>
	{
		...
		private IIfcPropertyEnumeration _enumerationReference;
		#endregion
		...
		public IIfcPropertyEnumeration @EnumerationReference 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 2: 
					...
					return;
				case 3: 
					_enumerationReference = (IIfcPropertyEnumeration)(value.EntityVal);
					return;
				default:
