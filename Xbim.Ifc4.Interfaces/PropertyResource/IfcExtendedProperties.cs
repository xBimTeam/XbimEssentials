...
namespace Xbim.Ifc4.Interfaces.PropertyResource
{
	...
	public abstract partial class @IfcExtendedProperties : IfcPropertyAbstraction, IIfcExtendedProperties, IEqualityComparer<@IfcExtendedProperties>, IEquatable<@IfcExtendedProperties>
	{
		...
		internal IfcExtendedProperties(IModel model) : base(model) 		{ 
			Model = model; 
			_properties = new ItemSet<IIfcProperty>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcIdentifier? _name;
		private IfcText? _description;
		private ItemSet<IIfcProperty> _properties;
		#endregion
		...
		public ItemSet<IIfcProperty> @Properties 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					if (_properties == null) _properties = new ItemSet<IIfcProperty>( this );
					_properties.InternalAdd((IIfcProperty)value.EntityVal);
					return;
				default:
