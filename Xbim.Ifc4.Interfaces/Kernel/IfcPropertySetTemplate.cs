...
namespace Xbim.Ifc4.Interfaces.Kernel
{
	...
	public  partial class @IfcPropertySetTemplate : IfcPropertyTemplateDefinition, IInstantiableEntity, IIfcPropertySetTemplate, IEqualityComparer<@IfcPropertySetTemplate>, IEquatable<@IfcPropertySetTemplate>
	{
		...
		internal IfcPropertySetTemplate(IModel model) : base(model) 		{ 
			Model = model; 
			_hasPropertyTemplates = new ItemSet<IIfcPropertyTemplate>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcPropertySetTemplateTypeEnum? _templateType;
		private IfcIdentifier? _applicableEntity;
		private ItemSet<IIfcPropertyTemplate> _hasPropertyTemplates;
		#endregion
		...
		public ItemSet<IIfcPropertyTemplate> @HasPropertyTemplates 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 5: 
					...
					return;
				case 6: 
					if (_hasPropertyTemplates == null) _hasPropertyTemplates = new ItemSet<IIfcPropertyTemplate>( this );
