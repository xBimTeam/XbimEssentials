...
namespace Xbim.Ifc4.Interfaces.Kernel
{
	...
	public  partial class @IfcRelAssignsToActor : IfcRelAssigns, IInstantiableEntity, IIfcRelAssignsToActor, IEqualityComparer<@IfcRelAssignsToActor>, IEquatable<@IfcRelAssignsToActor>
	{
		...
		public IIfcActorRole @ActingRole 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 5: 
					...
					return;
				case 6: 
					_relatingActor = (IIfcActor)(value.EntityVal);
					return;
				case 7: 
					_actingRole = (IIfcActorRole)(value.EntityVal);
					return;
				default:
