...
namespace Xbim.Ifc4.Interfaces.Kernel
{
	...
	public  partial class @IfcRelDefinesByTemplate : IfcRelDefines, IInstantiableEntity, IIfcRelDefinesByTemplate, IEqualityComparer<@IfcRelDefinesByTemplate>, IEquatable<@IfcRelDefinesByTemplate>
	{
		...
		internal IfcRelDefinesByTemplate(IModel model) : base(model) 		{ 
			Model = model; 
			_relatedPropertySets = new ItemSet<IIfcPropertySetDefinition>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcPropertySetDefinition> _relatedPropertySets;
		private IIfcPropertySetTemplate _relatingTemplate;
		#endregion
	
		#region Explicit attribute properties
		[IndexedProperty]
		[EntityAttribute(5, EntityAttributeState.Mandatory, EntityAttributeType.Set, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcPropertySetDefinition> @RelatedPropertySets 
		{ 
			get 
			{
		...
		public IIfcPropertySetTemplate @RelatingTemplate 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 3: 
					...
					return;
				case 4: 
					if (_relatedPropertySets == null) _relatedPropertySets = new ItemSet<IIfcPropertySetDefinition>( this );
					_relatedPropertySets.InternalAdd((IIfcPropertySetDefinition)value.EntityVal);
					return;
				case 5: 
					_relatingTemplate = (IIfcPropertySetTemplate)(value.EntityVal);
					return;
				default:
