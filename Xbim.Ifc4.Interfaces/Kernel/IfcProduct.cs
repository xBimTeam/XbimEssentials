...
namespace Xbim.Ifc4.Interfaces.Kernel
{
	...
	public abstract partial class @IfcProduct : IfcObject, IIfcProduct, IEqualityComparer<@IfcProduct>, IEquatable<@IfcProduct>
	{
		...
		private IIfcObjectPlacement _objectPlacement;
		private IIfcProductRepresentation _representation;
		#endregion
	
		#region Explicit attribute properties
		[IndexedProperty]
		[EntityAttribute(6, EntityAttributeState.Optional, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcObjectPlacement @ObjectPlacement 
		{ 
			get 
			{
		...
		public IIfcProductRepresentation @Representation 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 4: 
					...
					return;
				case 5: 
					_objectPlacement = (IIfcObjectPlacement)(value.EntityVal);
					return;
				case 6: 
					_representation = (IIfcProductRepresentation)(value.EntityVal);
					return;
				default:
