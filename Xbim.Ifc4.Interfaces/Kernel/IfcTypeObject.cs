...
namespace Xbim.Ifc4.Interfaces.Kernel
{
	...
	public  partial class @IfcTypeObject : IfcObjectDefinition, IInstantiableEntity, IIfcTypeObject, IEqualityComparer<@IfcTypeObject>, IEquatable<@IfcTypeObject>
	{
		...
		internal IfcTypeObject(IModel model) : base(model) 		{ 
			Model = model; 
			_hasPropertySets = new OptionalItemSet<IIfcPropertySetDefinition>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcIdentifier? _applicableOccurrence;
		private OptionalItemSet<IIfcPropertySetDefinition> _hasPropertySets;
		#endregion
		...
		public OptionalItemSet<IIfcPropertySetDefinition> @HasPropertySets 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 4: 
					...
					return;
				case 5: 
					if (_hasPropertySets == null) _hasPropertySets = new OptionalItemSet<IIfcPropertySetDefinition>( this );
					_hasPropertySets.InternalAdd((IIfcPropertySetDefinition)value.EntityVal);
					return;
				default:
