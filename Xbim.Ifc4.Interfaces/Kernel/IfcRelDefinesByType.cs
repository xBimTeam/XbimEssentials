...
namespace Xbim.Ifc4.Interfaces.Kernel
{
	...
	public  partial class @IfcRelDefinesByType : IfcRelDefines, IInstantiableEntity, IIfcRelDefinesByType, IEqualityComparer<@IfcRelDefinesByType>, IEquatable<@IfcRelDefinesByType>
	{
		...
		internal IfcRelDefinesByType(IModel model) : base(model) 		{ 
			Model = model; 
			_relatedObjects = new ItemSet<IIfcObject>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcObject> _relatedObjects;
		private IIfcTypeObject _relatingType;
		#endregion
	
		#region Explicit attribute properties
		[IndexedProperty]
		[EntityAttribute(5, EntityAttributeState.Mandatory, EntityAttributeType.Set, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcObject> @RelatedObjects 
		{ 
			get 
			{
		...
		public IIfcTypeObject @RelatingType 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 3: 
					...
					return;
				case 4: 
					if (_relatedObjects == null) _relatedObjects = new ItemSet<IIfcObject>( this );
					_relatedObjects.InternalAdd((IIfcObject)value.EntityVal);
					return;
				case 5: 
					_relatingType = (IIfcTypeObject)(value.EntityVal);
					return;
				default:
