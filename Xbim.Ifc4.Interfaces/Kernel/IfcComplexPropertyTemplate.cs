...
namespace Xbim.Ifc4.Interfaces.Kernel
{
	...
	public  partial class @IfcComplexPropertyTemplate : IfcPropertyTemplate, IInstantiableEntity, IIfcComplexPropertyTemplate, IEqualityComparer<@IfcComplexPropertyTemplate>, IEquatable<@IfcComplexPropertyTemplate>
	{
		...
		internal IfcComplexPropertyTemplate(IModel model) : base(model) 		{ 
			Model = model; 
			_hasPropertyTemplates = new OptionalItemSet<IIfcPropertyTemplate>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcLabel? _usageName;
		private IfcComplexPropertyTemplateTypeEnum? _templateType;
		private OptionalItemSet<IIfcPropertyTemplate> _hasPropertyTemplates;
		#endregion
		...
		public OptionalItemSet<IIfcPropertyTemplate> @HasPropertyTemplates 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 5: 
					...
					return;
				case 6: 
					if (_hasPropertyTemplates == null) _hasPropertyTemplates = new OptionalItemSet<IIfcPropertyTemplate>( this );
					_hasPropertyTemplates.InternalAdd((IIfcPropertyTemplate)value.EntityVal);
					return;
				default:
