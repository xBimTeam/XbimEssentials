...
namespace Xbim.Ifc4.Interfaces.Kernel
{
	...
	public abstract partial class @IfcContext : IfcObjectDefinition, IIfcContext, IEqualityComparer<@IfcContext>, IEquatable<@IfcContext>
	{
		...
		internal IfcContext(IModel model) : base(model) 		{ 
			Model = model; 
			_representationContexts = new OptionalItemSet<IIfcRepresentationContext>( this, 0 );
		}
		...
		private OptionalItemSet<IIfcRepresentationContext> _representationContexts;
		private IIfcUnitAssignment _unitsInContext;
		#endregion
		...
		public OptionalItemSet<IIfcRepresentationContext> @RepresentationContexts 
		{ 
			get 
			{
		...
		public IIfcUnitAssignment @UnitsInContext 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 6: 
					...
					return;
				case 7: 
					if (_representationContexts == null) _representationContexts = new OptionalItemSet<IIfcRepresentationContext>( this );
					_representationContexts.InternalAdd((IIfcRepresentationContext)value.EntityVal);
					return;
				case 8: 
					_unitsInContext = (IIfcUnitAssignment)(value.EntityVal);
					return;
				default:
