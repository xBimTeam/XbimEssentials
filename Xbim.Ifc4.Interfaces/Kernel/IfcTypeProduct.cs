...
namespace Xbim.Ifc4.Interfaces.Kernel
{
	...
	public  partial class @IfcTypeProduct : IfcTypeObject, IInstantiableEntity, IIfcTypeProduct, IEqualityComparer<@IfcTypeProduct>, IEquatable<@IfcTypeProduct>
	{
		...
		internal IfcTypeProduct(IModel model) : base(model) 		{ 
			Model = model; 
			_representationMaps = new OptionalItemSet<IIfcRepresentationMap>( this, 0 );
		}

		#region Explicit attribute fields
		private OptionalItemSet<IIfcRepresentationMap> _representationMaps;
		...
		public OptionalItemSet<IIfcRepresentationMap> @RepresentationMaps 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 5: 
					...
					return;
				case 6: 
					if (_representationMaps == null) _representationMaps = new OptionalItemSet<IIfcRepresentationMap>( this );
					_representationMaps.InternalAdd((IIfcRepresentationMap)value.EntityVal);
					return;
				case 7: 
