...
namespace Xbim.Ifc4.Interfaces.StructuralLoadResource
{
	...
	public  partial class @IfcStructuralLoadConfiguration : IfcStructuralLoad, IInstantiableEntity, IIfcStructuralLoadConfiguration, IEqualityComparer<@IfcStructuralLoadConfiguration>, IEquatable<@IfcStructuralLoadConfiguration>
	{
		...
		internal IfcStructuralLoadConfiguration(IModel model) : base(model) 		{ 
			Model = model; 
			_values = new ItemSet<IIfcStructuralLoadOrResult>( this, 0 );
			_locations = new OptionalItemSet<ItemSet<IfcLengthMeasure>>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcStructuralLoadOrResult> _values;
		...
		public ItemSet<IIfcStructuralLoadOrResult> @Values 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					if (_values == null) _values = new ItemSet<IIfcStructuralLoadOrResult>( this );
					_values.InternalAdd((IIfcStructuralLoadOrResult)value.EntityVal);
					return;
				case 2: 
					_locations
