...
namespace Xbim.Ifc4.Interfaces.ControlExtension
{
	...
	public  partial class @IfcRelAssociatesConstraint : IfcRelAssociates, IInstantiableEntity, IIfcRelAssociatesConstraint, IEqualityComparer<@IfcRelAssociatesConstraint>, IEquatable<@IfcRelAssociatesConstraint>
	{
		...
		private IIfcConstraint _relatingConstraint;
		#endregion
		...
		public IIfcConstraint @RelatingConstraint 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 5: 
					...
					return;
				case 6: 
					_relatingConstraint = (IIfcConstraint)(value.EntityVal);
					return;
				default:
