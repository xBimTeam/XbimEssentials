...
namespace Xbim.Ifc4.Interfaces.ArchitectureDomain
{
	...
	public  partial class @IfcDoorLiningProperties : IfcPreDefinedPropertySet, IInstantiableEntity, IIfcDoorLiningProperties, IEqualityComparer<@IfcDoorLiningProperties>, IEquatable<@IfcDoorLiningProperties>
	{
		...
		private IIfcShapeAspect _shapeAspectStyle;
		...
		public IIfcShapeAspect @ShapeAspectStyle 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 13: 
					...
					return;
				case 14: 
					_shapeAspectStyle = (IIfcShapeAspect)(value.EntityVal);
					return;
				case 15: 
