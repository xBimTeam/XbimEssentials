...
namespace Xbim.Ifc4.Interfaces.GeometricConstraintResource
{
	...
	public  partial class @IfcGridPlacement : IfcObjectPlacement, IInstantiableEntity, IIfcGridPlacement, IEqualityComparer<@IfcGridPlacement>, IEquatable<@IfcGridPlacement>
	{
		...
		private IIfcVirtualGridIntersection _placementLocation;
		private IfcGridPlacementDirectionSelect _placementRefDirection;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcVirtualGridIntersection @PlacementLocation 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_placementLocation = (IIfcVirtualGridIntersection)(value.EntityVal);
					return;
				case 1: 
