...
namespace Xbim.Ifc4.Interfaces.GeometricConstraintResource
{
	...
	public  partial class @IfcVirtualGridIntersection : INotifyPropertyChanged, IInstantiableEntity, IIfcVirtualGridIntersection, IEqualityComparer<@IfcVirtualGridIntersection>, IEquatable<@IfcVirtualGridIntersection>
	{
		...
		internal IfcVirtualGridIntersection(IModel model) 		{ 
			Model = model; 
			_intersectingAxes = new ItemSet<IIfcGridAxis>( this, 2 );
			_offsetDistances = new ItemSet<IfcLengthMeasure>( this, 3 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcGridAxis> _intersectingAxes;
		...
		public ItemSet<IIfcGridAxis> @IntersectingAxes 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_intersectingAxes == null) _intersectingAxes = new ItemSet<IIfcGridAxis>( this );
					_intersectingAxes.InternalAdd((IIfcGridAxis)value.EntityVal);
					return;
				case 1: 
