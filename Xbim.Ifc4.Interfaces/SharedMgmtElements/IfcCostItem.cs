...
namespace Xbim.Ifc4.Interfaces.SharedMgmtElements
{
	...
	public  partial class @IfcCostItem : IfcControl, IInstantiableEntity, IIfcCostItem, IEqualityComparer<@IfcCostItem>, IEquatable<@IfcCostItem>
	{
		...
		internal IfcCostItem(IModel model) : base(model) 		{ 
			Model = model; 
			_costValues = new OptionalItemSet<IIfcCostValue>( this, 0 );
			_costQuantities = new OptionalItemSet<IIfcPhysicalQuantity>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcCostItemTypeEnum? _predefinedType;
		private OptionalItemSet<IIfcCostValue> _costValues;
		private OptionalItemSet<IIfcPhysicalQuantity> _costQuantities;
		#endregion
		...
		public OptionalItemSet<IIfcCostValue> @CostValues 
		{ 
			get 
			{
		...
		public OptionalItemSet<IIfcPhysicalQuantity> @CostQuantities 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 6: 
					...
					return;
				case 7: 
					if (_costValues == null) _costValues = new OptionalItemSet<IIfcCostValue>( this );
					_costValues.InternalAdd((IIfcCostValue)value.EntityVal);
					return;
				case 8: 
					if (_costQuantities == null) _costQuantities = new OptionalItemSet<IIfcPhysicalQuantity>( this );
					_costQuantities.InternalAdd((IIfcPhysicalQuantity)value.EntityVal);
					return;
				default:
