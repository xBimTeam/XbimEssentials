...
namespace Xbim.Ifc4.Interfaces.ExternalReferenceResource
{
	...
	public  partial class @IfcDocumentReference : IfcExternalReference, IInstantiableEntity, IIfcDocumentReference, IEqualityComparer<@IfcDocumentReference>, IEquatable<@IfcDocumentReference>
	{
		...
		private IIfcDocumentInformation _referencedDocument;
		#endregion
		...
		public IIfcDocumentInformation @ReferencedDocument 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 3: 
					...
					return;
				case 4: 
					_referencedDocument = (IIfcDocumentInformation)(value.EntityVal);
					return;
				default:
