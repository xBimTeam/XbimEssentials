...
namespace Xbim.Ifc4.Interfaces.ExternalReferenceResource
{
	...
	public  partial class @IfcDocumentInformationRelationship : IfcResourceLevelRelationship, IInstantiableEntity, IIfcDocumentInformationRelationship, IEqualityComparer<@IfcDocumentInformationRelationship>, IEquatable<@IfcDocumentInformationRelationship>
	{
		...
		internal IfcDocumentInformationRelationship(IModel model) : base(model) 		{ 
			Model = model; 
			_relatedDocuments = new ItemSet<IIfcDocumentInformation>( this, 0 );
		}

		#region Explicit attribute fields
		private IIfcDocumentInformation _relatingDocument;
		private ItemSet<IIfcDocumentInformation> _relatedDocuments;
		...
		public IIfcDocumentInformation @RelatingDocument 
		{ 
			get 
			{
		...
		public ItemSet<IIfcDocumentInformation> @RelatedDocuments 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					_relatingDocument = (IIfcDocumentInformation)(value.EntityVal);
					return;
				case 3: 
					if (_relatedDocuments == null) _relatedDocuments = new ItemSet<IIfcDocumentInformation>( this );
					_relatedDocuments.InternalAdd((IIfcDocumentInformation)value.EntityVal);
					return;
				case 4: 
