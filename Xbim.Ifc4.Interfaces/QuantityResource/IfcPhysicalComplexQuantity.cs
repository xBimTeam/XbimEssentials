...
namespace Xbim.Ifc4.Interfaces.QuantityResource
{
	...
	public  partial class @IfcPhysicalComplexQuantity : IfcPhysicalQuantity, IInstantiableEntity, IIfcPhysicalComplexQuantity, IEqualityComparer<@IfcPhysicalComplexQuantity>, IEquatable<@IfcPhysicalComplexQuantity>
	{
		...
		internal IfcPhysicalComplexQuantity(IModel model) : base(model) 		{ 
			Model = model; 
			_hasQuantities = new ItemSet<IIfcPhysicalQuantity>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcPhysicalQuantity> _hasQuantities;
		...
		public ItemSet<IIfcPhysicalQuantity> @HasQuantities 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					if (_hasQuantities == null) _hasQuantities = new ItemSet<IIfcPhysicalQuantity>( this );
					_hasQuantities.InternalAdd((IIfcPhysicalQuantity)value.EntityVal);
					return;
				case 3: 
