...
namespace Xbim.Ifc4.Interfaces.TopologyResource
{
	...
	public  partial class @IfcFace : IfcTopologicalRepresentationItem, IInstantiableEntity, IIfcFace, IEqualityComparer<@IfcFace>, IEquatable<@IfcFace>
	{
		...
		internal IfcFace(IModel model) : base(model) 		{ 
			Model = model; 
			_bounds = new ItemSet<IIfcFaceBound>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcFaceBound> _bounds;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Set, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcFaceBound> @Bounds 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_bounds == null) _bounds = new ItemSet<IIfcFaceBound>( this );
					_bounds.InternalAdd((IIfcFaceBound)value.EntityVal);
					return;
				default:
