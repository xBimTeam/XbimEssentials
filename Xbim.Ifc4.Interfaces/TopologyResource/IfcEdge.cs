...
namespace Xbim.Ifc4.Interfaces.TopologyResource
{
	...
	public  partial class @IfcEdge : IfcTopologicalRepresentationItem, IInstantiableEntity, IIfcEdge, IEqualityComparer<@IfcEdge>, IEquatable<@IfcEdge>
	{
		...
		private IIfcVertex _edgeStart;
		private IIfcVertex _edgeEnd;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public virtual IIfcVertex @EdgeStart 
		{ 
			get 
			{
		...
		public virtual IIfcVertex @EdgeEnd 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_edgeStart = (IIfcVertex)(value.EntityVal);
					return;
				case 1: 
					_edgeEnd = (IIfcVertex)(value.EntityVal);
					return;
				default:
