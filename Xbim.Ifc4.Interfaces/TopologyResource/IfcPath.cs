...
namespace Xbim.Ifc4.Interfaces.TopologyResource
{
	...
	public  partial class @IfcPath : IfcTopologicalRepresentationItem, IInstantiableEntity, IIfcPath, IEqualityComparer<@IfcPath>, IEquatable<@IfcPath>
	{
		...
		internal IfcPath(IModel model) : base(model) 		{ 
			Model = model; 
			_edgeList = new ItemSet<IIfcOrientedEdge>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcOrientedEdge> _edgeList;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.List, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcOrientedEdge> @EdgeList 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_edgeList == null) _edgeList = new ItemSet<IIfcOrientedEdge>( this );
					_edgeList.InternalAdd((IIfcOrientedEdge)value.EntityVal);
					return;
				default:
