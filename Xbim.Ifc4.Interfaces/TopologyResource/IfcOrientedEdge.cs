...
namespace Xbim.Ifc4.Interfaces.TopologyResource
{
	...
	public  partial class @IfcOrientedEdge : IfcEdge, IInstantiableEntity, IIfcOrientedEdge, IEqualityComparer<@IfcOrientedEdge>, IEquatable<@IfcOrientedEdge>
	{
		...
		private IIfcEdge _edgeElement;
		private bool _orientation;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(3, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcEdge @EdgeElement 
		{ 
			get 
			{
		...
		public override IIfcVertex @EdgeStart 
		{
			get 
			{
		...
		public override IIfcVertex @EdgeEnd 
		{
			get 
			{
				throw new System.NotImplementedException();
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					_edgeElement = (IIfcEdge)(value.EntityVal);
					return;
				case 3: 
