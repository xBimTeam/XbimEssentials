...
namespace Xbim.Ifc4.Interfaces.TopologyResource
{
	...
	public  partial class @IfcPolyLoop : IfcLoop, IInstantiableEntity, IIfcPolyLoop, IEqualityComparer<@IfcPolyLoop>, IEquatable<@IfcPolyLoop>
	{
		...
		internal IfcPolyLoop(IModel model) : base(model) 		{ 
			Model = model; 
			_polygon = new ItemSet<IIfcCartesianPoint>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcCartesianPoint> _polygon;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.List, EntityAttributeType.Class, 3, -1)]
		public ItemSet<IIfcCartesianPoint> @Polygon 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_polygon == null) _polygon = new ItemSet<IIfcCartesianPoint>( this );
					_polygon.InternalAdd((IIfcCartesianPoint)value.EntityVal);
					return;
				default:
