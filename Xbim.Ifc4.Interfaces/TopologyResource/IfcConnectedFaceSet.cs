...
namespace Xbim.Ifc4.Interfaces.TopologyResource
{
	...
	public  partial class @IfcConnectedFaceSet : IfcTopologicalRepresentationItem, IInstantiableEntity, IIfcConnectedFaceSet, IEqualityComparer<@IfcConnectedFaceSet>, IEquatable<@IfcConnectedFaceSet>
	{
		...
		internal IfcConnectedFaceSet(IModel model) : base(model) 		{ 
			Model = model; 
			_cfsFaces = new ItemSet<IIfcFace>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcFace> _cfsFaces;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Set, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcFace> @CfsFaces 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_cfsFaces == null) _cfsFaces = new ItemSet<IIfcFace>( this );
					_cfsFaces.InternalAdd((IIfcFace)value.EntityVal);
					return;
				default:
