...
namespace Xbim.Ifc4.Interfaces.UtilityResource
{
	...
	public  partial class @IfcOwnerHistory : INotifyPropertyChanged, IInstantiableEntity, IIfcOwnerHistory, IEqualityComparer<@IfcOwnerHistory>, IEquatable<@IfcOwnerHistory>
	{
		...
		private IIfcPersonAndOrganization _owningUser;
		private IIfcApplication _owningApplication;
		private IfcStateEnum? _state;
		private IfcChangeActionEnum? _changeAction;
		private IfcTimeStamp? _lastModifiedDate;
		private IIfcPersonAndOrganization _lastModifyingUser;
		private IIfcApplication _lastModifyingApplication;
		private IfcTimeStamp _creationDate;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcPersonAndOrganization @OwningUser 
		{ 
			get 
			{
		...
		public IIfcApplication @OwningApplication 
		{ 
			get 
			{
		...
		public IIfcPersonAndOrganization @LastModifyingUser 
		{ 
			get 
			{
		...
		public IIfcApplication @LastModifyingApplication 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_owningUser = (IIfcPersonAndOrganization)(value.EntityVal);
					return;
				case 1: 
					_owningApplication = (IIfcApplication)(value.EntityVal);
					return;
				case 2: 
				...
				case 4: 
					...
					return;
				case 5: 
					_lastModifyingUser = (IIfcPersonAndOrganization)(value.EntityVal);
					return;
				case 6: 
					_lastModifyingApplication = (IIfcApplication)(value.EntityVal);
					return;
				case 7: 
