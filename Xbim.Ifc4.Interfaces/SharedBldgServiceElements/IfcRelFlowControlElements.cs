...
namespace Xbim.Ifc4.Interfaces.SharedBldgServiceElements
{
	...
	public  partial class @IfcRelFlowControlElements : IfcRelConnects, IInstantiableEntity, IIfcRelFlowControlElements, IEqualityComparer<@IfcRelFlowControlElements>, IEquatable<@IfcRelFlowControlElements>
	{
		...
		internal IfcRelFlowControlElements(IModel model) : base(model) 		{ 
			Model = model; 
			_relatedControlElements = new ItemSet<IIfcDistributionControlElement>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcDistributionControlElement> _relatedControlElements;
		private IIfcDistributionFlowElement _relatingFlowElement;
		#endregion
	
		#region Explicit attribute properties
		[IndexedProperty]
		[EntityAttribute(5, EntityAttributeState.Mandatory, EntityAttributeType.Set, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcDistributionControlElement> @RelatedControlElements 
		{ 
			get 
			{
		...
		public IIfcDistributionFlowElement @RelatingFlowElement 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 3: 
					...
					return;
				case 4: 
					if (_relatedControlElements == null) _relatedControlElements = new ItemSet<IIfcDistributionControlElement>( this );
					_relatedControlElements.InternalAdd((IIfcDistributionControlElement)value.EntityVal);
					return;
				case 5: 
					_relatingFlowElement = (IIfcDistributionFlowElement)(value.EntityVal);
					return;
				default:
