...
namespace Xbim.Ifc4.Interfaces.GeometryResource
{
	...
	public  partial class @IfcMappedItem : IfcRepresentationItem, IInstantiableEntity, IIfcMappedItem, IEqualityComparer<@IfcMappedItem>, IEquatable<@IfcMappedItem>
	{
		...
		private IIfcRepresentationMap _mappingSource;
		private IIfcCartesianTransformationOperator _mappingTarget;
		#endregion
	
		#region Explicit attribute properties
		[IndexedProperty]
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcRepresentationMap @MappingSource 
		{ 
			get 
			{
		...
		public IIfcCartesianTransformationOperator @MappingTarget 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_mappingSource = (IIfcRepresentationMap)(value.EntityVal);
					return;
				case 1: 
					_mappingTarget = (IIfcCartesianTransformationOperator)(value.EntityVal);
					return;
				default:
