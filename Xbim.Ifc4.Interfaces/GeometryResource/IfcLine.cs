...
namespace Xbim.Ifc4.Interfaces.GeometryResource
{
	...
	public  partial class @IfcLine : IfcCurve, IInstantiableEntity, IIfcLine, IEqualityComparer<@IfcLine>, IEquatable<@IfcLine>
	{
		...
		private IIfcCartesianPoint _pnt;
		private IIfcVector _dir;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcCartesianPoint @Pnt 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_pnt = (IIfcCartesianPoint)(value.EntityVal);
					return;
				case 1: 
					_dir = (IIfcVector)(value.EntityVal);
					return;
				default:
