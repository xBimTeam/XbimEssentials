...
namespace Xbim.Ifc4.Interfaces.GeometryResource
{
	...
	public  partial class @IfcCurveBoundedSurface : IfcBoundedSurface, IInstantiableEntity, IIfcCurveBoundedSurface, IEqualityComparer<@IfcCurveBoundedSurface>, IEquatable<@IfcCurveBoundedSurface>
	{
		...
		internal IfcCurveBoundedSurface(IModel model) : base(model) 		{ 
			Model = model; 
			_boundaries = new ItemSet<IIfcBoundaryCurve>( this, 0 );
		}

		#region Explicit attribute fields
		private IIfcSurface _basisSurface;
		private ItemSet<IIfcBoundaryCurve> _boundaries;
		...
		public ItemSet<IIfcBoundaryCurve> @Boundaries 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					if (_boundaries == null) _boundaries = new ItemSet<IIfcBoundaryCurve>( this );
					_boundaries.InternalAdd((IIfcBoundaryCurve)value.EntityVal);
					return;
				case 2: 
