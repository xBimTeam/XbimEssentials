...
namespace Xbim.Ifc4.Interfaces.GeometryResource
{
	...
	public  partial class @IfcOffsetCurve3D : IfcCurve, IInstantiableEntity, IIfcOffsetCurve3D, IEqualityComparer<@IfcOffsetCurve3D>, IEquatable<@IfcOffsetCurve3D>
	{
		...
		private IIfcCurve _basisCurve;
		private IfcLengthMeasure _distance;
		private bool? _selfIntersect;
		private IIfcDirection _refDirection;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcCurve @BasisCurve 
		{ 
			get 
			{
		...
		public IIfcDirection @RefDirection 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_basisCurve = (IIfcCurve)(value.EntityVal);
					return;
				case 1: 
				...
				case 2: 
					...
					return;
				case 3: 
					_refDirection = (IIfcDirection)(value.EntityVal);
					return;
				default:
