...
namespace Xbim.Ifc4.Interfaces.GeometryResource
{
	...
	public abstract partial class @IfcBSplineCurve : IfcBoundedCurve, IIfcBSplineCurve, IEqualityComparer<@IfcBSplineCurve>, IEquatable<@IfcBSplineCurve>
	{
		...
		internal IfcBSplineCurve(IModel model) : base(model) 		{ 
			Model = model; 
			_controlPointsList = new ItemSet<IIfcCartesianPoint>( this, 0 );
		}

		#region Explicit attribute fields
		private long _degree;
		private ItemSet<IIfcCartesianPoint> _controlPointsList;
		...
		public ItemSet<IIfcCartesianPoint> @ControlPointsList 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					if (_controlPointsList == null) _controlPointsList = new ItemSet<IIfcCartesianPoint>( this );
					_controlPointsList.InternalAdd((IIfcCartesianPoint)value.EntityVal);
					return;
				case 2: 
