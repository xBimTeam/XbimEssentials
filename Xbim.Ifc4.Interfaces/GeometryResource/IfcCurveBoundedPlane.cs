...
namespace Xbim.Ifc4.Interfaces.GeometryResource
{
	...
	public  partial class @IfcCurveBoundedPlane : IfcBoundedSurface, IInstantiableEntity, IIfcCurveBoundedPlane, IEqualityComparer<@IfcCurveBoundedPlane>, IEquatable<@IfcCurveBoundedPlane>
	{
		...
		internal IfcCurveBoundedPlane(IModel model) : base(model) 		{ 
			Model = model; 
			_innerBoundaries = new ItemSet<IIfcCurve>( this, 0 );
		}

		#region Explicit attribute fields
		private IIfcPlane _basisSurface;
		private IIfcCurve _outerBoundary;
		private ItemSet<IIfcCurve> _innerBoundaries;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcPlane @BasisSurface 
		{ 
			get 
			{
		...
		public ItemSet<IIfcCurve> @InnerBoundaries 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_basisSurface = (IIfcPlane)(value.EntityVal);
					return;
				case 1: 
					_outerBoundary = (IIfcCurve)(value.EntityVal);
					return;
				case 2: 
					if (_innerBoundaries == null) _innerBoundaries = new ItemSet<IIfcCurve>( this );
