...
namespace Xbim.Ifc4.Interfaces.GeometryResource
{
	...
	public  partial class @IfcPolyline : IfcBoundedCurve, IInstantiableEntity, IIfcPolyline, IEqualityComparer<@IfcPolyline>, IEquatable<@IfcPolyline>
	{
		...
		internal IfcPolyline(IModel model) : base(model) 		{ 
			Model = model; 
			_points = new ItemSet<IIfcCartesianPoint>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcCartesianPoint> _points;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.List, EntityAttributeType.Class, 2, -1)]
		public ItemSet<IIfcCartesianPoint> @Points 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_points == null) _points = new ItemSet<IIfcCartesianPoint>( this );
					_points.InternalAdd((IIfcCartesianPoint)value.EntityVal);
					return;
				default:
