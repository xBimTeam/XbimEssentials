...
namespace Xbim.Ifc4.Interfaces.GeometryResource
{
	...
	public abstract partial class @IfcBSplineSurface : IfcBoundedSurface, IIfcBSplineSurface, IEqualityComparer<@IfcBSplineSurface>, IEquatable<@IfcBSplineSurface>
	{
		...
		internal IfcBSplineSurface(IModel model) : base(model) 		{ 
			Model = model; 
			_controlPointsList = new ItemSet<ItemSet<IIfcCartesianPoint>>( this, 0 );
		}

		#region Explicit attribute fields
		private long _uDegree;
		private long _vDegree;
		private ItemSet<ItemSet<IIfcCartesianPoint>> _controlPointsList;
		...
		public ItemSet<ItemSet<IIfcCartesianPoint>> @ControlPointsList 
		{ 
			get 
			{
			...
			switch (propIndex)
			{
				...
				case 2: 
					_controlPointsList
						...
						.InternalAdd((IIfcCartesianPoint)(value.EntityVal));
					return;
				case 3: 
