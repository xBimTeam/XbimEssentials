...
namespace Xbim.Ifc4.Interfaces.GeometryResource
{
	...
	public  partial class @IfcRepresentationMap : INotifyPropertyChanged, IInstantiableEntity, IIfcRepresentationMap, IEqualityComparer<@IfcRepresentationMap>, IEquatable<@IfcRepresentationMap>
	{
		...
		private IIfcRepresentation _mappedRepresentation;
		#endregion
		...
		public IIfcRepresentation @MappedRepresentation 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					_mappedRepresentation = (IIfcRepresentation)(value.EntityVal);
					return;
				default:
