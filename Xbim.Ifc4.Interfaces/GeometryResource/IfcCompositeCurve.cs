...
namespace Xbim.Ifc4.Interfaces.GeometryResource
{
	...
	public  partial class @IfcCompositeCurve : IfcBoundedCurve, IInstantiableEntity, IIfcCompositeCurve, IEqualityComparer<@IfcCompositeCurve>, IEquatable<@IfcCompositeCurve>
	{
		...
		internal IfcCompositeCurve(IModel model) : base(model) 		{ 
			Model = model; 
			_segments = new ItemSet<IIfcCompositeCurveSegment>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcCompositeCurveSegment> _segments;
		...
		public ItemSet<IIfcCompositeCurveSegment> @Segments 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_segments == null) _segments = new ItemSet<IIfcCompositeCurveSegment>( this );
					_segments.InternalAdd((IIfcCompositeCurveSegment)value.EntityVal);
					return;
				case 1: 
