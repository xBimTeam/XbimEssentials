...
namespace Xbim.Ifc4.Interfaces.DateTimeResource
{
	...
	public  partial class @IfcRegularTimeSeries : IfcTimeSeries, IInstantiableEntity, IIfcRegularTimeSeries, IEqualityComparer<@IfcRegularTimeSeries>, IEquatable<@IfcRegularTimeSeries>
	{
		...
		internal IfcRegularTimeSeries(IModel model) : base(model) 		{ 
			Model = model; 
			_values = new ItemSet<IIfcTimeSeriesValue>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcTimeMeasure _timeStep;
		private ItemSet<IIfcTimeSeriesValue> _values;
		#endregion
		...
		public ItemSet<IIfcTimeSeriesValue> @Values 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 8: 
					...
					return;
				case 9: 
					if (_values == null) _values = new ItemSet<IIfcTimeSeriesValue>( this );
					_values.InternalAdd((IIfcTimeSeriesValue)value.EntityVal);
					return;
				default:
