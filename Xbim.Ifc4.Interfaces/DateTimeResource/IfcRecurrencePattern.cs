...
namespace Xbim.Ifc4.Interfaces.DateTimeResource
{
	...
	public  partial class @IfcRecurrencePattern : INotifyPropertyChanged, IInstantiableEntity, IIfcRecurrencePattern, IEqualityComparer<@IfcRecurrencePattern>, IEquatable<@IfcRecurrencePattern>
	{
		...
		internal IfcRecurrencePattern(IModel model) 		{ 
			...
			_timePeriods = new OptionalItemSet<IIfcTimePeriod>( this, 0 );
		}
		...
		private OptionalItemSet<IIfcTimePeriod> _timePeriods;
		#endregion
		...
		public OptionalItemSet<IIfcTimePeriod> @TimePeriods 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 6: 
					...
					return;
				case 7: 
					if (_timePeriods == null) _timePeriods = new OptionalItemSet<IIfcTimePeriod>( this );
					_timePeriods.InternalAdd((IIfcTimePeriod)value.EntityVal);
					return;
				default:
