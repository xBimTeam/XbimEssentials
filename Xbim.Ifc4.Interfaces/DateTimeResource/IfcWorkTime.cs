...
namespace Xbim.Ifc4.Interfaces.DateTimeResource
{
	...
	public  partial class @IfcWorkTime : IfcSchedulingTime, IInstantiableEntity, IIfcWorkTime, IEqualityComparer<@IfcWorkTime>, IEquatable<@IfcWorkTime>
	{
		...
		private IIfcRecurrencePattern _recurrencePattern;
		...
		public IIfcRecurrencePattern @RecurrencePattern 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 2: 
					...
					return;
				case 3: 
					_recurrencePattern = (IIfcRecurrencePattern)(value.EntityVal);
					return;
				case 4: 
