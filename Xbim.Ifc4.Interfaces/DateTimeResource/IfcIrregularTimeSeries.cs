...
namespace Xbim.Ifc4.Interfaces.DateTimeResource
{
	...
	public  partial class @IfcIrregularTimeSeries : IfcTimeSeries, IInstantiableEntity, IIfcIrregularTimeSeries, IEqualityComparer<@IfcIrregularTimeSeries>, IEquatable<@IfcIrregularTimeSeries>
	{
		...
		internal IfcIrregularTimeSeries(IModel model) : base(model) 		{ 
			Model = model; 
			_values = new ItemSet<IIfcIrregularTimeSeriesValue>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcIrregularTimeSeriesValue> _values;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(9, EntityAttributeState.Mandatory, EntityAttributeType.List, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcIrregularTimeSeriesValue> @Values 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
					if (_values == null) _values = new ItemSet<IIfcIrregularTimeSeriesValue>( this );
					_values.InternalAdd((IIfcIrregularTimeSeriesValue)value.EntityVal);
					return;
				default:
