...
namespace Xbim.Ifc4.Interfaces.RepresentationResource
{
	...
	public abstract partial class @IfcRepresentation : IPersistEntity, INotifyPropertyChanged, IIfcRepresentation, IEqualityComparer<@IfcRepresentation>, IEquatable<@IfcRepresentation>
	{
		...
		internal IfcRepresentation(IModel model) 		{ 
			Model = model; 
			_items = new ItemSet<IIfcRepresentationItem>( this, 0 );
		}

		#region Explicit attribute fields
		private IIfcRepresentationContext _contextOfItems;
		private IfcLabel? _representationIdentifier;
		private IfcLabel? _representationType;
		private ItemSet<IIfcRepresentationItem> _items;
		#endregion
	
		#region Explicit attribute properties
		[IndexedProperty]
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcRepresentationContext @ContextOfItems 
		{ 
			get 
			{
		...
		public ItemSet<IIfcRepresentationItem> @Items 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_contextOfItems = (IIfcRepresentationContext)(value.EntityVal);
					return;
				case 1: 
				...
				case 2: 
					...
					return;
				case 3: 
					if (_items == null) _items = new ItemSet<IIfcRepresentationItem>( this );
					_items.InternalAdd((IIfcRepresentationItem)value.EntityVal);
					return;
				default:
