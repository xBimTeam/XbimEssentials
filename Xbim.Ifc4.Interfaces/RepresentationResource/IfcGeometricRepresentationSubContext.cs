...
namespace Xbim.Ifc4.Interfaces.RepresentationResource
{
	...
	public  partial class @IfcGeometricRepresentationSubContext : IfcGeometricRepresentationContext, IInstantiableEntity, IIfcGeometricRepresentationSubContext, IEqualityComparer<@IfcGeometricRepresentationSubContext>, IEquatable<@IfcGeometricRepresentationSubContext>
	{
		...
		private IIfcGeometricRepresentationContext _parentContext;
		...
		public IIfcGeometricRepresentationContext @ParentContext 
		{ 
			get 
			{
		...
		public override IIfcDirection @TrueNorth 
		{
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 5: 
					...
					return;
				case 6: 
					_parentContext = (IIfcGeometricRepresentationContext)(value.EntityVal);
					return;
				case 7: 
