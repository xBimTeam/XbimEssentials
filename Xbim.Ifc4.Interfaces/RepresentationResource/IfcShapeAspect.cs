...
namespace Xbim.Ifc4.Interfaces.RepresentationResource
{
	...
	public  partial class @IfcShapeAspect : INotifyPropertyChanged, IInstantiableEntity, IIfcShapeAspect, IEqualityComparer<@IfcShapeAspect>, IEquatable<@IfcShapeAspect>
	{
		...
		internal IfcShapeAspect(IModel model) 		{ 
			Model = model; 
			_shapeRepresentations = new ItemSet<IIfcShapeModel>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcShapeModel> _shapeRepresentations;
		...
		public ItemSet<IIfcShapeModel> @ShapeRepresentations 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_shapeRepresentations == null) _shapeRepresentations = new ItemSet<IIfcShapeModel>( this );
					_shapeRepresentations.InternalAdd((IIfcShapeModel)value.EntityVal);
					return;
				case 1: 
