...
namespace Xbim.Ifc4.Interfaces.RepresentationResource
{
	...
	public abstract partial class @IfcProductRepresentation : IPersistEntity, INotifyPropertyChanged, IIfcProductRepresentation, IEqualityComparer<@IfcProductRepresentation>, IEquatable<@IfcProductRepresentation>
	{
		...
		internal IfcProductRepresentation(IModel model) 		{ 
			Model = model; 
			_representations = new ItemSet<IIfcRepresentation>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcLabel? _name;
		private IfcText? _description;
		private ItemSet<IIfcRepresentation> _representations;
		#endregion
		...
		public ItemSet<IIfcRepresentation> @Representations 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					if (_representations == null) _representations = new ItemSet<IIfcRepresentation>( this );
					_representations.InternalAdd((IIfcRepresentation)value.EntityVal);
					return;
				default:
