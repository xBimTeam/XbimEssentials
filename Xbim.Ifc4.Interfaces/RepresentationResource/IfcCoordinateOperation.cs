...
namespace Xbim.Ifc4.Interfaces.RepresentationResource
{
	...
	public abstract partial class @IfcCoordinateOperation : IPersistEntity, INotifyPropertyChanged, IIfcCoordinateOperation, IEqualityComparer<@IfcCoordinateOperation>, IEquatable<@IfcCoordinateOperation>
	{
		...
		private IIfcCoordinateReferenceSystem _targetCRS;
		#endregion
		...
		public IIfcCoordinateReferenceSystem @TargetCRS 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					_targetCRS = (IIfcCoordinateReferenceSystem)(value.EntityVal);
					return;
				default:
