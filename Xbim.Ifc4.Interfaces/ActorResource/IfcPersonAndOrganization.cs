...
namespace Xbim.Ifc4.Interfaces.ActorResource
{
	...
	public  partial class @IfcPersonAndOrganization : INotifyPropertyChanged, IInstantiableEntity, IIfcPersonAndOrganization, IEqualityComparer<@IfcPersonAndOrganization>, IEquatable<@IfcPersonAndOrganization>
	{
		...
		private IIfcPerson _thePerson;
		private IIfcOrganization _theOrganization;
		...
		public IIfcOrganization @TheOrganization 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_thePerson = (IIfcPerson)(value.EntityVal);
					return;
				case 1: 
					_theOrganization = (IIfcOrganization)(value.EntityVal);
					return;
				case 2: 
