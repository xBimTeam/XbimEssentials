...
namespace Xbim.Ifc4.Interfaces.ActorResource
{
	...
	public  partial class @IfcPerson : INotifyPropertyChanged, IInstantiableEntity, IIfcPerson, IEqualityComparer<@IfcPerson>, IEquatable<@IfcPerson>
	{
		...
		internal IfcPerson(IModel model) 		{ 
			...
			_roles = new OptionalItemSet<IIfcActorRole>( this, 0 );
			_addresses = new OptionalItemSet<IIfcAddress>( this, 0 );
		}
		...
		private OptionalItemSet<IIfcActorRole> _roles;
		private OptionalItemSet<IIfcAddress> _addresses;
		#endregion
		...
		public OptionalItemSet<IIfcActorRole> @Roles 
		{ 
			get 
			{
		...
		public OptionalItemSet<IIfcAddress> @Addresses 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 5: 
					...
					return;
				case 6: 
					if (_roles == null) _roles = new OptionalItemSet<IIfcActorRole>( this );
					_roles.InternalAdd((IIfcActorRole)value.EntityVal);
					return;
				case 7: 
					if (_addresses == null) _addresses = new OptionalItemSet<IIfcAddress>( this );
					_addresses.InternalAdd((IIfcAddress)value.EntityVal);
					return;
				default:
