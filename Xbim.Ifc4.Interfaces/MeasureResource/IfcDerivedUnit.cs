...
namespace Xbim.Ifc4.Interfaces.MeasureResource
{
	...
	public  partial class @IfcDerivedUnit : INotifyPropertyChanged, IInstantiableEntity, IIfcDerivedUnit, IEqualityComparer<@IfcDerivedUnit>, IEquatable<@IfcDerivedUnit>
	{
		...
		internal IfcDerivedUnit(IModel model) 		{ 
			Model = model; 
			_elements = new ItemSet<IIfcDerivedUnitElement>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcDerivedUnitElement> _elements;
		...
		public ItemSet<IIfcDerivedUnitElement> @Elements 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_elements == null) _elements = new ItemSet<IIfcDerivedUnitElement>( this );
					_elements.InternalAdd((IIfcDerivedUnitElement)value.EntityVal);
					return;
				case 1: 
