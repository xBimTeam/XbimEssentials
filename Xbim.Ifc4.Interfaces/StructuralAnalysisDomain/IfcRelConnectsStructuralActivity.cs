...
namespace Xbim.Ifc4.Interfaces.StructuralAnalysisDomain
{
	...
	public  partial class @IfcRelConnectsStructuralActivity : IfcRelConnects, IInstantiableEntity, IIfcRelConnectsStructuralActivity, IEqualityComparer<@IfcRelConnectsStructuralActivity>, IEquatable<@IfcRelConnectsStructuralActivity>
	{
		...
		private IIfcStructuralActivity _relatedStructuralActivity;
		#endregion
		...
		public IIfcStructuralActivity @RelatedStructuralActivity 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 4: 
					...
					return;
				case 5: 
					_relatedStructuralActivity = (IIfcStructuralActivity)(value.EntityVal);
					return;
				default:
