...
namespace Xbim.Ifc4.Interfaces.StructuralAnalysisDomain
{
	...
	public  partial class @IfcStructuralResultGroup : IfcGroup, IInstantiableEntity, IIfcStructuralResultGroup, IEqualityComparer<@IfcStructuralResultGroup>, IEquatable<@IfcStructuralResultGroup>
	{
		...
		private IIfcStructuralLoadGroup _resultForLoadGroup;
		...
		public IIfcStructuralLoadGroup @ResultForLoadGroup 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 5: 
					...
					return;
				case 6: 
					_resultForLoadGroup = (IIfcStructuralLoadGroup)(value.EntityVal);
					return;
				case 7: 
