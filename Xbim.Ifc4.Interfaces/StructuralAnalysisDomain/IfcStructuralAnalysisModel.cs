...
namespace Xbim.Ifc4.Interfaces.StructuralAnalysisDomain
{
	...
	public  partial class @IfcStructuralAnalysisModel : IfcSystem, IInstantiableEntity, IIfcStructuralAnalysisModel, IEqualityComparer<@IfcStructuralAnalysisModel>, IEquatable<@IfcStructuralAnalysisModel>
	{
		...
		internal IfcStructuralAnalysisModel(IModel model) : base(model) 		{ 
			Model = model; 
			_loadedBy = new OptionalItemSet<IIfcStructuralLoadGroup>( this, 0 );
			_hasResults = new OptionalItemSet<IIfcStructuralResultGroup>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcAnalysisModelTypeEnum _predefinedType;
		private IIfcAxis2Placement3D _orientationOf2DPlane;
		private OptionalItemSet<IIfcStructuralLoadGroup> _loadedBy;
		private OptionalItemSet<IIfcStructuralResultGroup> _hasResults;
		...
		public IIfcAxis2Placement3D @OrientationOf2DPlane 
		{ 
			get 
			{
		...
		public OptionalItemSet<IIfcStructuralLoadGroup> @LoadedBy 
		{ 
			get 
			{
		...
		public OptionalItemSet<IIfcStructuralResultGroup> @HasResults 
		{ 
			get 
			{
		...
		public IIfcObjectPlacement @SharedPlacement 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 5: 
					...
					return;
				case 6: 
					_orientationOf2DPlane = (IIfcAxis2Placement3D)(value.EntityVal);
					return;
				case 7: 
					if (_loadedBy == null) _loadedBy = new OptionalItemSet<IIfcStructuralLoadGroup>( this );
					_loadedBy.InternalAdd((IIfcStructuralLoadGroup)value.EntityVal);
					return;
				case 8: 
					if (_hasResults == null) _hasResults = new OptionalItemSet<IIfcStructuralResultGroup>( this );
					_hasResults.InternalAdd((IIfcStructuralResultGroup)value.EntityVal);
					return;
				case 9: 
					_sharedPlacement = (IIfcObjectPlacement)(value.EntityVal);
					return;
				default:
