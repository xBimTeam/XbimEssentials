		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 9: 
					...
					return;
				case 10: 
					_connectionConstraint = (IIfcConnectionGeometry)(value.EntityVal);
					return;
				default:
