...
namespace Xbim.Ifc4.Interfaces.PresentationDefinitionResource
{
	...
	public  partial class @IfcAnnotationFillArea : IfcGeometricRepresentationItem, IInstantiableEntity, IIfcAnnotationFillArea, IEqualityComparer<@IfcAnnotationFillArea>, IEquatable<@IfcAnnotationFillArea>
	{
		...
		internal IfcAnnotationFillArea(IModel model) : base(model) 		{ 
			Model = model; 
			_innerBoundaries = new OptionalItemSet<IIfcCurve>( this, 0 );
		}

		#region Explicit attribute fields
		private IIfcCurve _outerBoundary;
		private OptionalItemSet<IIfcCurve> _innerBoundaries;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcCurve @OuterBoundary 
		{ 
			get 
			{
		...
		public OptionalItemSet<IIfcCurve> @InnerBoundaries 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_outerBoundary = (IIfcCurve)(value.EntityVal);
					return;
				case 1: 
					if (_innerBoundaries == null) _innerBoundaries = new OptionalItemSet<IIfcCurve>( this );
					_innerBoundaries.InternalAdd((IIfcCurve)value.EntityVal);
					return;
				default:
