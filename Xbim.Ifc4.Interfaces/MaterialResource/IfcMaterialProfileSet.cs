...
namespace Xbim.Ifc4.Interfaces.MaterialResource
{
	...
	public  partial class @IfcMaterialProfileSet : IfcMaterialDefinition, IInstantiableEntity, IIfcMaterialProfileSet, IEqualityComparer<@IfcMaterialProfileSet>, IEquatable<@IfcMaterialProfileSet>
	{
		...
		internal IfcMaterialProfileSet(IModel model) : base(model) 		{ 
			Model = model; 
			_materialProfiles = new ItemSet<IIfcMaterialProfile>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcLabel? _name;
		private IfcText? _description;
		private ItemSet<IIfcMaterialProfile> _materialProfiles;
		private IIfcCompositeProfileDef _compositeProfile;
		#endregion
		...
		public ItemSet<IIfcMaterialProfile> @MaterialProfiles 
		{ 
			get 
			{
		...
		public IIfcCompositeProfileDef @CompositeProfile 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					if (_materialProfiles == null) _materialProfiles = new ItemSet<IIfcMaterialProfile>( this );
					_materialProfiles.InternalAdd((IIfcMaterialProfile)value.EntityVal);
					return;
				case 3: 
					_compositeProfile = (IIfcCompositeProfileDef)(value.EntityVal);
					return;
				default:
