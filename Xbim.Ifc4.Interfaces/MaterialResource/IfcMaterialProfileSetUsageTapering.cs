...
namespace Xbim.Ifc4.Interfaces.MaterialResource
{
	...
	public  partial class @IfcMaterialProfileSetUsageTapering : IfcMaterialProfileSetUsage, IInstantiableEntity, IIfcMaterialProfileSetUsageTapering, IEqualityComparer<@IfcMaterialProfileSetUsageTapering>, IEquatable<@IfcMaterialProfileSetUsageTapering>
	{
		...
		private IIfcMaterialProfileSet _forProfileEndSet;
		...
		public IIfcMaterialProfileSet @ForProfileEndSet 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 2: 
					...
					return;
				case 3: 
					_forProfileEndSet = (IIfcMaterialProfileSet)(value.EntityVal);
					return;
				case 4: 
