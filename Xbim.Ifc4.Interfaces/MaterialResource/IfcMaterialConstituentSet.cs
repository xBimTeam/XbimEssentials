...
namespace Xbim.Ifc4.Interfaces.MaterialResource
{
	...
	public  partial class @IfcMaterialConstituentSet : IfcMaterialDefinition, IInstantiableEntity, IIfcMaterialConstituentSet, IEqualityComparer<@IfcMaterialConstituentSet>, IEquatable<@IfcMaterialConstituentSet>
	{
		...
		internal IfcMaterialConstituentSet(IModel model) : base(model) 		{ 
			Model = model; 
			_materialConstituents = new OptionalItemSet<IIfcMaterialConstituent>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcLabel? _name;
		private IfcText? _description;
		private OptionalItemSet<IIfcMaterialConstituent> _materialConstituents;
		#endregion
		...
		public OptionalItemSet<IIfcMaterialConstituent> @MaterialConstituents 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					if (_materialConstituents == null) _materialConstituents = new OptionalItemSet<IIfcMaterialConstituent>( this );
					_materialConstituents.InternalAdd((IIfcMaterialConstituent)value.EntityVal);
					return;
				default:
