...
namespace Xbim.Ifc4.Interfaces.MaterialResource
{
	...
	public  partial class @IfcMaterialList : INotifyPropertyChanged, IInstantiableEntity, IIfcMaterialList, IEqualityComparer<@IfcMaterialList>, IEquatable<@IfcMaterialList>
	{
		...
		internal IfcMaterialList(IModel model) 		{ 
			Model = model; 
			_materials = new ItemSet<IIfcMaterial>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcMaterial> _materials;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.List, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcMaterial> @Materials 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_materials == null) _materials = new ItemSet<IIfcMaterial>( this );
					_materials.InternalAdd((IIfcMaterial)value.EntityVal);
					return;
				default:
