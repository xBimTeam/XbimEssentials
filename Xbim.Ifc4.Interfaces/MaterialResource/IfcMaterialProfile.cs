...
namespace Xbim.Ifc4.Interfaces.MaterialResource
{
	...
	public  partial class @IfcMaterialProfile : IfcMaterialDefinition, IInstantiableEntity, IIfcMaterialProfile, IEqualityComparer<@IfcMaterialProfile>, IEquatable<@IfcMaterialProfile>
	{
		...
		private IIfcProfileDef _profile;
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					_material = (IIfcMaterial)(value.EntityVal);
					return;
				case 3: 
					_profile = (IIfcProfileDef)(value.EntityVal);
					return;
				case 4: 
