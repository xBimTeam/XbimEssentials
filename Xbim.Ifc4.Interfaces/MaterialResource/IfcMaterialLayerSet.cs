...
namespace Xbim.Ifc4.Interfaces.MaterialResource
{
	...
	public  partial class @IfcMaterialLayerSet : IfcMaterialDefinition, IInstantiableEntity, IIfcMaterialLayerSet, IEqualityComparer<@IfcMaterialLayerSet>, IEquatable<@IfcMaterialLayerSet>
	{
		...
		internal IfcMaterialLayerSet(IModel model) : base(model) 		{ 
			Model = model; 
			_materialLayers = new ItemSet<IIfcMaterialLayer>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcMaterialLayer> _materialLayers;
		...
		public ItemSet<IIfcMaterialLayer> @MaterialLayers 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_materialLayers == null) _materialLayers = new ItemSet<IIfcMaterialLayer>( this );
					_materialLayers.InternalAdd((IIfcMaterialLayer)value.EntityVal);
					return;
				case 1: 
