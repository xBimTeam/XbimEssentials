...
namespace Xbim.Ifc4.Interfaces.GeometricModelResource
{
	...
	public  partial class @IfcFixedReferenceSweptAreaSolid : IfcSweptAreaSolid, IInstantiableEntity, IIfcFixedReferenceSweptAreaSolid, IEqualityComparer<@IfcFixedReferenceSweptAreaSolid>, IEquatable<@IfcFixedReferenceSweptAreaSolid>
	{
		...
		public IIfcDirection @FixedReference 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					_directrix = (IIfcCurve)(value.EntityVal);
					return;
				case 3: 
				...
				case 4: 
					...
					return;
				case 5: 
					_fixedReference = (IIfcDirection)(value.EntityVal);
					return;
				default:
