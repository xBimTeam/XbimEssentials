...
namespace Xbim.Ifc4.Interfaces.GeometricModelResource
{
	...
	public  partial class @IfcFaceBasedSurfaceModel : IfcGeometricRepresentationItem, IInstantiableEntity, IIfcFaceBasedSurfaceModel, IEqualityComparer<@IfcFaceBasedSurfaceModel>, IEquatable<@IfcFaceBasedSurfaceModel>
	{
		...
		internal IfcFaceBasedSurfaceModel(IModel model) : base(model) 		{ 
			Model = model; 
			_fbsmFaces = new ItemSet<IIfcConnectedFaceSet>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcConnectedFaceSet> _fbsmFaces;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Set, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcConnectedFaceSet> @FbsmFaces 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_fbsmFaces == null) _fbsmFaces = new ItemSet<IIfcConnectedFaceSet>( this );
					_fbsmFaces.InternalAdd((IIfcConnectedFaceSet)value.EntityVal);
					return;
				default:
