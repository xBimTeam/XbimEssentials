...
namespace Xbim.Ifc4.Interfaces.GeometricModelResource
{
	...
	public  partial class @IfcFacetedBrepWithVoids : IfcFacetedBrep, IInstantiableEntity, IIfcFacetedBrepWithVoids, IEqualityComparer<@IfcFacetedBrepWithVoids>, IEquatable<@IfcFacetedBrepWithVoids>
	{
		...
		internal IfcFacetedBrepWithVoids(IModel model) : base(model) 		{ 
			Model = model; 
			_voids = new ItemSet<IIfcClosedShell>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcClosedShell> _voids;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(2, EntityAttributeState.Mandatory, EntityAttributeType.Set, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcClosedShell> @Voids 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					if (_voids == null) _voids = new ItemSet<IIfcClosedShell>( this );
					_voids.InternalAdd((IIfcClosedShell)value.EntityVal);
					return;
				default:
