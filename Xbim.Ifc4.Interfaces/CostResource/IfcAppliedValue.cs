...
namespace Xbim.Ifc4.Interfaces.CostResource
{
	...
	public  partial class @IfcAppliedValue : INotifyPropertyChanged, IInstantiableEntity, IIfcAppliedValue, IEqualityComparer<@IfcAppliedValue>, IEquatable<@IfcAppliedValue>
	{
		...
		internal IfcAppliedValue(IModel model) 		{ 
			Model = model; 
			_components = new OptionalItemSet<IIfcAppliedValue>( this, 0 );
		}
		...
		private IIfcMeasureWithUnit _unitBasis;
		...
		private OptionalItemSet<IIfcAppliedValue> _components;
		#endregion
		...
		public IIfcMeasureWithUnit @UnitBasis 
		{ 
			get 
			{
		...
		public OptionalItemSet<IIfcAppliedValue> @Components 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 2: 
					...
					return;
				case 3: 
					_unitBasis = (IIfcMeasureWithUnit)(value.EntityVal);
					return;
				case 4: 
				...
				case 8: 
					...
					return;
				case 9: 
					if (_components == null) _components = new OptionalItemSet<IIfcAppliedValue>( this );
					_components.InternalAdd((IIfcAppliedValue)value.EntityVal);
					return;
				default:
