...
namespace Xbim.Ifc4.Interfaces.CostResource
{
	[IndexedClass]
	...
	public  partial class @IfcCurrencyRelationship : IfcResourceLevelRelationship, IInstantiableEntity, IIfcCurrencyRelationship, IEqualityComparer<@IfcCurrencyRelationship>, IEquatable<@IfcCurrencyRelationship>
	{
		...
		private IIfcMonetaryUnit _relatingMonetaryUnit;
		private IIfcMonetaryUnit _relatedMonetaryUnit;
		private IfcPositiveRatioMeasure _exchangeRate;
		private IfcDateTime? _rateDateTime;
		private IIfcLibraryInformation _rateSource;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(3, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcMonetaryUnit @RelatingMonetaryUnit 
		{ 
			get 
			{
		...
		public IIfcMonetaryUnit @RelatedMonetaryUnit 
		{ 
			get 
			{
		...
		public IIfcLibraryInformation @RateSource 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					_relatingMonetaryUnit = (IIfcMonetaryUnit)(value.EntityVal);
					return;
				case 3: 
					_relatedMonetaryUnit = (IIfcMonetaryUnit)(value.EntityVal);
					return;
				case 4: 
				...
				case 5: 
					...
					return;
				case 6: 
					_rateSource = (IIfcLibraryInformation)(value.EntityVal);
					return;
				default:
