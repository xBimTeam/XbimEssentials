...
namespace Xbim.Ifc4.Interfaces.PresentationAppearanceResource
{
	...
	public  partial class @IfcFillAreaStyleHatching : IfcGeometricRepresentationItem, IInstantiableEntity, IIfcFillAreaStyleHatching, IEqualityComparer<@IfcFillAreaStyleHatching>, IEquatable<@IfcFillAreaStyleHatching>
	{
		...
		private IIfcCurveStyle _hatchLineAppearance;
		private IfcHatchLineDistanceSelect _startOfNextHatchLine;
		private IIfcCartesianPoint _pointOfReferenceHatchLine;
		private IIfcCartesianPoint _patternStart;
		private IfcPlaneAngleMeasure _hatchLineAngle;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcCurveStyle @HatchLineAppearance 
		{ 
			get 
			{
		...
		public IIfcCartesianPoint @PointOfReferenceHatchLine 
		{ 
			get 
			{
		...
		public IIfcCartesianPoint @PatternStart 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_hatchLineAppearance = (IIfcCurveStyle)(value.EntityVal);
					return;
				case 1: 
					_startOfNextHatchLine = (IfcHatchLineDistanceSelect)(value.EntityVal);
					return;
				case 2: 
					_pointOfReferenceHatchLine = (IIfcCartesianPoint)(value.EntityVal);
					return;
				case 3: 
					_patternStart = (IIfcCartesianPoint)(value.EntityVal);
					return;
				case 4: 
