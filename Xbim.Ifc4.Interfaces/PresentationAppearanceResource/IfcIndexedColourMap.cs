...
namespace Xbim.Ifc4.Interfaces.PresentationAppearanceResource
{
	...
	public  partial class @IfcIndexedColourMap : IfcPresentationItem, IInstantiableEntity, IIfcIndexedColourMap, IEqualityComparer<@IfcIndexedColourMap>, IEquatable<@IfcIndexedColourMap>
	{
		...
		private IIfcTessellatedFaceSet _mappedTo;
		private IIfcSurfaceStyleShading _overrides;
		private IIfcColourRgbList _colours;
		...
		public IIfcTessellatedFaceSet @MappedTo 
		{ 
			get 
			{
		...
		public IIfcSurfaceStyleShading @Overrides 
		{ 
			get 
			{
		...
		public IIfcColourRgbList @Colours 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					_mappedTo = (IIfcTessellatedFaceSet)(value.EntityVal);
					return;
				case 1: 
					_overrides = (IIfcSurfaceStyleShading)(value.EntityVal);
					return;
				case 2: 
					_colours = (IIfcColourRgbList)(value.EntityVal);
					return;
				case 3: 
