...
namespace Xbim.Ifc4.Interfaces.PresentationAppearanceResource
{
	...
	public  partial class @IfcSurfaceStyleWithTextures : IfcPresentationItem, IInstantiableEntity, IIfcSurfaceStyleWithTextures, IEqualityComparer<@IfcSurfaceStyleWithTextures>, IEquatable<@IfcSurfaceStyleWithTextures>
	{
		...
		internal IfcSurfaceStyleWithTextures(IModel model) : base(model) 		{ 
			Model = model; 
			_textures = new ItemSet<IIfcSurfaceTexture>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcSurfaceTexture> _textures;
		#endregion
	
		#region Explicit attribute properties
		[IndexedProperty]
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.List, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcSurfaceTexture> @Textures 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_textures == null) _textures = new ItemSet<IIfcSurfaceTexture>( this );
					_textures.InternalAdd((IIfcSurfaceTexture)value.EntityVal);
					return;
				default:
