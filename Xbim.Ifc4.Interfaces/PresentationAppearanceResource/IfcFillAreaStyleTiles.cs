...
namespace Xbim.Ifc4.Interfaces.PresentationAppearanceResource
{
	...
	public  partial class @IfcFillAreaStyleTiles : IfcGeometricRepresentationItem, IInstantiableEntity, IIfcFillAreaStyleTiles, IEqualityComparer<@IfcFillAreaStyleTiles>, IEquatable<@IfcFillAreaStyleTiles>
	{
		...
		internal IfcFillAreaStyleTiles(IModel model) : base(model) 		{ 
			Model = model; 
			_tilingPattern = new ItemSet<IIfcVector>( this, 2 );
			_tiles = new ItemSet<IIfcStyledItem>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcVector> _tilingPattern;
		private ItemSet<IIfcStyledItem> _tiles;
		...
		public ItemSet<IIfcVector> @TilingPattern 
		{ 
			get 
			{
		...
		public ItemSet<IIfcStyledItem> @Tiles 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_tilingPattern == null) _tilingPattern = new ItemSet<IIfcVector>( this );
					_tilingPattern.InternalAdd((IIfcVector)value.EntityVal);
					return;
				case 1: 
					if (_tiles == null) _tiles = new ItemSet<IIfcStyledItem>( this );
					_tiles.InternalAdd((IIfcStyledItem)value.EntityVal);
					return;
				case 2: 
