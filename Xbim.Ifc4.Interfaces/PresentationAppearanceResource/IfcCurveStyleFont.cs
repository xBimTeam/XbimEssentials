...
namespace Xbim.Ifc4.Interfaces.PresentationAppearanceResource
{
	...
	public  partial class @IfcCurveStyleFont : IfcPresentationItem, IInstantiableEntity, IIfcCurveStyleFont, IEqualityComparer<@IfcCurveStyleFont>, IEquatable<@IfcCurveStyleFont>
	{
		...
		internal IfcCurveStyleFont(IModel model) : base(model) 		{ 
			Model = model; 
			_patternList = new ItemSet<IIfcCurveStyleFontPattern>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcLabel? _name;
		private ItemSet<IIfcCurveStyleFontPattern> _patternList;
		#endregion
		...
		public ItemSet<IIfcCurveStyleFontPattern> @PatternList 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					if (_patternList == null) _patternList = new ItemSet<IIfcCurveStyleFontPattern>( this );
					_patternList.InternalAdd((IIfcCurveStyleFontPattern)value.EntityVal);
					return;
				default:
