...
namespace Xbim.Ifc4.Interfaces.PresentationAppearanceResource
{
	...
	public  partial class @IfcTextStyle : IfcPresentationStyle, IInstantiableEntity, IIfcTextStyle, IEqualityComparer<@IfcTextStyle>, IEquatable<@IfcTextStyle>
	{
		...
		private IIfcTextStyleForDefinedFont _textCharacterAppearance;
		private IIfcTextStyleTextModel _textStyle;
		...
		public IIfcTextStyleForDefinedFont @TextCharacterAppearance 
		{ 
			get 
			{
		...
		public IIfcTextStyleTextModel @TextStyle 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					_textCharacterAppearance = (IIfcTextStyleForDefinedFont)(value.EntityVal);
					return;
				case 2: 
					_textStyle = (IIfcTextStyleTextModel)(value.EntityVal);
					return;
				case 3: 
