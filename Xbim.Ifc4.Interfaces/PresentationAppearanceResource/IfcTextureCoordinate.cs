...
namespace Xbim.Ifc4.Interfaces.PresentationAppearanceResource
{
	...
	public abstract partial class @IfcTextureCoordinate : IfcPresentationItem, IIfcTextureCoordinate, IEqualityComparer<@IfcTextureCoordinate>, IEquatable<@IfcTextureCoordinate>
	{
		...
		internal IfcTextureCoordinate(IModel model) : base(model) 		{ 
			Model = model; 
			_maps = new ItemSet<IIfcSurfaceTexture>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcSurfaceTexture> _maps;
		#endregion
	
		#region Explicit attribute properties
		[IndexedProperty]
		[EntityAttribute(1, EntityAttributeState.Mandatory, EntityAttributeType.List, EntityAttributeType.Class, 1, -1)]
		public ItemSet<IIfcSurfaceTexture> @Maps 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			...
			{
				case 0: 
					if (_maps == null) _maps = new ItemSet<IIfcSurfaceTexture>( this );
					_maps.InternalAdd((IIfcSurfaceTexture)value.EntityVal);
					return;
				default:
