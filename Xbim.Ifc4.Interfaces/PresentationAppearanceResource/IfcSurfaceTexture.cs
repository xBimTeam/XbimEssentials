...
namespace Xbim.Ifc4.Interfaces.PresentationAppearanceResource
{
	...
	public abstract partial class @IfcSurfaceTexture : IfcPresentationItem, IIfcSurfaceTexture, IEqualityComparer<@IfcSurfaceTexture>, IEquatable<@IfcSurfaceTexture>
	{
		...
		private IIfcCartesianTransformationOperator2D _textureTransform;
		...
		public IIfcCartesianTransformationOperator2D @TextureTransform 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 2: 
					...
					return;
				case 3: 
					_textureTransform = (IIfcCartesianTransformationOperator2D)(value.EntityVal);
					return;
				case 4: 
