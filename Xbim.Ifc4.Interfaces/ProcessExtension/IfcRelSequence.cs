...
namespace Xbim.Ifc4.Interfaces.ProcessExtension
{
	...
	public  partial class @IfcRelSequence : IfcRelConnects, IInstantiableEntity, IIfcRelSequence, IEqualityComparer<@IfcRelSequence>, IEquatable<@IfcRelSequence>
	{
		...
		private IIfcProcess _relatingProcess;
		private IIfcProcess _relatedProcess;
		private IIfcLagTime _timeLag;
		...
		public IIfcProcess @RelatingProcess 
		{ 
			get 
			{
		...
		public IIfcProcess @RelatedProcess 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 3: 
					...
					return;
				case 4: 
					_relatingProcess = (IIfcProcess)(value.EntityVal);
					return;
				case 5: 
					_relatedProcess = (IIfcProcess)(value.EntityVal);
					return;
				case 6: 
					_timeLag = (IIfcLagTime)(value.EntityVal);
					return;
				case 7: 
