...
namespace Xbim.Ifc4.Interfaces.ProcessExtension
{
	...
	public abstract partial class @IfcWorkControl : IfcControl, IIfcWorkControl, IEqualityComparer<@IfcWorkControl>, IEquatable<@IfcWorkControl>
	{
		...
		internal IfcWorkControl(IModel model) : base(model) 		{ 
			Model = model; 
			_creators = new OptionalItemSet<IIfcPerson>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcDateTime _creationDate;
		private OptionalItemSet<IIfcPerson> _creators;
		...
		public OptionalItemSet<IIfcPerson> @Creators 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 6: 
					...
					return;
				case 7: 
					if (_creators == null) _creators = new OptionalItemSet<IIfcPerson>( this );
					_creators.InternalAdd((IIfcPerson)value.EntityVal);
					return;
				case 8: 
