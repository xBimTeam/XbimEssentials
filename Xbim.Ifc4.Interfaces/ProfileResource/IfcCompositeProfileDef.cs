...
namespace Xbim.Ifc4.Interfaces.ProfileResource
{
	...
	public  partial class @IfcCompositeProfileDef : IfcProfileDef, IInstantiableEntity, IIfcCompositeProfileDef, IEqualityComparer<@IfcCompositeProfileDef>, IEquatable<@IfcCompositeProfileDef>
	{
		...
		internal IfcCompositeProfileDef(IModel model) : base(model) 		{ 
			Model = model; 
			_profiles = new ItemSet<IIfcProfileDef>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcProfileDef> _profiles;
		...
		public ItemSet<IIfcProfileDef> @Profiles 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					if (_profiles == null) _profiles = new ItemSet<IIfcProfileDef>( this );
					_profiles.InternalAdd((IIfcProfileDef)value.EntityVal);
					return;
				case 3: 
