...
namespace Xbim.Ifc4.Interfaces.ProfileResource
{
	...
	public  partial class @IfcDerivedProfileDef : IfcProfileDef, IInstantiableEntity, IIfcDerivedProfileDef, IEqualityComparer<@IfcDerivedProfileDef>, IEquatable<@IfcDerivedProfileDef>
	{
		...
		private IIfcProfileDef _parentProfile;
		private IIfcCartesianTransformationOperator2D _operator;
		private IfcLabel? _label;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(3, EntityAttributeState.Mandatory, EntityAttributeType.Class, EntityAttributeType.None, -1, -1)]
		public IIfcProfileDef @ParentProfile 
		{ 
			get 
			{
		...
		public virtual IIfcCartesianTransformationOperator2D @Operator 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 1: 
					...
					return;
				case 2: 
					_parentProfile = (IIfcProfileDef)(value.EntityVal);
					return;
				case 3: 
					_operator = (IIfcCartesianTransformationOperator2D)(value.EntityVal);
					return;
				case 4: 
