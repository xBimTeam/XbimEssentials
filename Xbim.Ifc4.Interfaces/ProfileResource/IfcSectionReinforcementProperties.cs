...
namespace Xbim.Ifc4.Interfaces.ProfileResource
{
	...
	public  partial class @IfcSectionReinforcementProperties : IfcPreDefinedProperties, IInstantiableEntity, IIfcSectionReinforcementProperties, IEqualityComparer<@IfcSectionReinforcementProperties>, IEquatable<@IfcSectionReinforcementProperties>
	{
		...
		internal IfcSectionReinforcementProperties(IModel model) : base(model) 		{ 
			Model = model; 
			_crossSectionReinforcementDefinitions = new ItemSet<IIfcReinforcementBarProperties>( this, 0 );
		}
		...
		private IIfcSectionProperties _sectionDefinition;
		private ItemSet<IIfcReinforcementBarProperties> _crossSectionReinforcementDefinitions;
		#endregion
		...
		public IIfcSectionProperties @SectionDefinition 
		{ 
			get 
			{
		...
		public ItemSet<IIfcReinforcementBarProperties> @CrossSectionReinforcementDefinitions 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 3: 
					...
					return;
				case 4: 
					_sectionDefinition = (IIfcSectionProperties)(value.EntityVal);
					return;
				case 5: 
					if (_crossSectionReinforcementDefinitions == null) _crossSectionReinforcementDefinitions = new ItemSet<IIfcReinforcementBarProperties>( this );
					_crossSectionReinforcementDefinitions.InternalAdd((IIfcReinforcementBarProperties)value.EntityVal);
					return;
				default:
