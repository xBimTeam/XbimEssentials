...
namespace Xbim.Ifc4.Interfaces.ProfileResource
{
	...
	public  partial class @IfcSectionProperties : IfcPreDefinedProperties, IInstantiableEntity, IIfcSectionProperties, IEqualityComparer<@IfcSectionProperties>, IEquatable<@IfcSectionProperties>
	{
		...
		private IIfcProfileDef _startProfile;
		private IIfcProfileDef _endProfile;
		#endregion
		...
		public IIfcProfileDef @StartProfile 
		{ 
			get 
			{
		...
		public IIfcProfileDef @EndProfile 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					_startProfile = (IIfcProfileDef)(value.EntityVal);
					return;
				case 2: 
					_endProfile = (IIfcProfileDef)(value.EntityVal);
					return;
				default:
