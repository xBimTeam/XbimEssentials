...
namespace Xbim.Ifc4.Interfaces.SharedFacilitiesElements
{
	...
	public  partial class @IfcInventory : IfcGroup, IInstantiableEntity, IIfcInventory, IEqualityComparer<@IfcInventory>, IEquatable<@IfcInventory>
	{
		...
		internal IfcInventory(IModel model) : base(model) 		{ 
			Model = model; 
			_responsiblePersons = new OptionalItemSet<IIfcPerson>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcInventoryTypeEnum? _predefinedType;
		private IfcActorSelect _jurisdiction;
		private OptionalItemSet<IIfcPerson> _responsiblePersons;
		...
		public OptionalItemSet<IIfcPerson> @ResponsiblePersons 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 6: 
					...
					return;
				case 7: 
					if (_responsiblePersons == null) _responsiblePersons = new OptionalItemSet<IIfcPerson>( this );
					_responsiblePersons.InternalAdd((IIfcPerson)value.EntityVal);
					return;
				case 8: 
