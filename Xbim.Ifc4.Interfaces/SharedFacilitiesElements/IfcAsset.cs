...
namespace Xbim.Ifc4.Interfaces.SharedFacilitiesElements
{
	...
	public  partial class @IfcAsset : IfcGroup, IInstantiableEntity, IIfcAsset, IEqualityComparer<@IfcAsset>, IEquatable<@IfcAsset>
	{
		...
		private IIfcCostValue _originalValue;
		private IIfcCostValue _currentValue;
		private IIfcCostValue _totalReplacementCost;
		private IfcActorSelect _owner;
		private IfcActorSelect _user;
		private IIfcPerson _responsiblePerson;
		private IfcDate? _incorporationDate;
		private IIfcCostValue _depreciatedValue;
		#endregion
		...
		public IIfcCostValue @OriginalValue 
		{ 
			get 
			{
		...
		public IIfcCostValue @CurrentValue 
		{ 
			get 
			{
		...
		public IIfcCostValue @TotalReplacementCost 
		{ 
			get 
			{
		...
		public IIfcPerson @ResponsiblePerson 
		{ 
			get 
			{
		...
		public IIfcCostValue @DepreciatedValue 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 5: 
					...
					return;
				case 6: 
					_originalValue = (IIfcCostValue)(value.EntityVal);
					return;
				case 7: 
					_currentValue = (IIfcCostValue)(value.EntityVal);
					return;
				case 8: 
					_totalReplacementCost = (IIfcCostValue)(value.EntityVal);
					return;
				case 9: 
				...
				case 10: 
					...
					return;
				case 11: 
					_responsiblePerson = (IIfcPerson)(value.EntityVal);
					return;
				case 12: 
					_incorporationDate = value.StringVal;
					return;
				case 13: 
					_depreciatedValue = (IIfcCostValue)(value.EntityVal);
					return;
				default:
