...
namespace Xbim.Ifc4.Interfaces.ConstraintResource
{
	...
	public  partial class @IfcObjective : IfcConstraint, IInstantiableEntity, IIfcObjective, IEqualityComparer<@IfcObjective>, IEquatable<@IfcObjective>
	{
		...
		internal IfcObjective(IModel model) : base(model) 		{ 
			Model = model; 
			_benchmarkValues = new OptionalItemSet<IIfcConstraint>( this, 0 );
		}

		#region Explicit attribute fields
		private OptionalItemSet<IIfcConstraint> _benchmarkValues;
		...
		public OptionalItemSet<IIfcConstraint> @BenchmarkValues 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 6: 
					...
					return;
				case 7: 
					if (_benchmarkValues == null) _benchmarkValues = new OptionalItemSet<IIfcConstraint>( this );
					_benchmarkValues.InternalAdd((IIfcConstraint)value.EntityVal);
					return;
				case 8: 
