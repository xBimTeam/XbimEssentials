...
namespace Xbim.Ifc4.Interfaces.PresentationOrganizationResource
{
	...
	public  partial class @IfcLightIntensityDistribution : INotifyPropertyChanged, IInstantiableEntity, IIfcLightIntensityDistribution, IEqualityComparer<@IfcLightIntensityDistribution>, IEquatable<@IfcLightIntensityDistribution>
	{
		...
		internal IfcLightIntensityDistribution(IModel model) 		{ 
			Model = model; 
			_distributionData = new ItemSet<IIfcLightDistributionData>( this, 0 );
		}

		#region Explicit attribute fields
		private IfcLightDistributionCurveEnum _lightDistributionCurve;
		private ItemSet<IIfcLightDistributionData> _distributionData;
		#endregion
		...
		public ItemSet<IIfcLightDistributionData> @DistributionData 
		{ 
			get 
			{
		...
		public virtual void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					if (_distributionData == null) _distributionData = new ItemSet<IIfcLightDistributionData>( this );
					_distributionData.InternalAdd((IIfcLightDistributionData)value.EntityVal);
					return;
				default:
