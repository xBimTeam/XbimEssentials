...
namespace Xbim.Ifc4.Interfaces.PresentationOrganizationResource
{
	...
	public  partial class @IfcPresentationLayerWithStyle : IfcPresentationLayerAssignment, IInstantiableEntity, IIfcPresentationLayerWithStyle, IEqualityComparer<@IfcPresentationLayerWithStyle>, IEquatable<@IfcPresentationLayerWithStyle>
	{
		...
		internal IfcPresentationLayerWithStyle(IModel model) : base(model) 		{ 
			Model = model; 
			_layerStyles = new ItemSet<IIfcPresentationStyle>( this, 0 );
		}
		...
		private ItemSet<IIfcPresentationStyle> _layerStyles;
		#endregion
		...
		public ItemSet<IIfcPresentationStyle> @LayerStyles 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 6: 
					...
					return;
				case 7: 
					if (_layerStyles == null) _layerStyles = new ItemSet<IIfcPresentationStyle>( this );
					_layerStyles.InternalAdd((IIfcPresentationStyle)value.EntityVal);
					return;
				default:
