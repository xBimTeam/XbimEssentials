...
namespace Xbim.Ifc4.Interfaces.ProductExtension
{
	...
	public  partial class @IfcRelConnectsPorts : IfcRelConnects, IInstantiableEntity, IIfcRelConnectsPorts, IEqualityComparer<@IfcRelConnectsPorts>, IEquatable<@IfcRelConnectsPorts>
	{
		...
		private IIfcPort _relatedPort;
		private IIfcElement _realizingElement;
		#endregion
		...
		public IIfcElement @RealizingElement 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 4: 
					...
					return;
				case 5: 
					_relatedPort = (IIfcPort)(value.EntityVal);
					return;
				case 6: 
					_realizingElement = (IIfcElement)(value.EntityVal);
					return;
				default:
