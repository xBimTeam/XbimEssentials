...
namespace Xbim.Ifc4.Interfaces.ProductExtension
{
	...
	public  partial class @IfcRelConnectsElements : IfcRelConnects, IInstantiableEntity, IIfcRelConnectsElements, IEqualityComparer<@IfcRelConnectsElements>, IEquatable<@IfcRelConnectsElements>
	{
		...
		private IIfcConnectionGeometry _connectionGeometry;
		...
		public IIfcConnectionGeometry @ConnectionGeometry 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 3: 
					...
					return;
				case 4: 
					_connectionGeometry = (IIfcConnectionGeometry)(value.EntityVal);
					return;
				case 5: 
