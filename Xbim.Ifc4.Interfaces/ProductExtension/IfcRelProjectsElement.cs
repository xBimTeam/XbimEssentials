...
namespace Xbim.Ifc4.Interfaces.ProductExtension
{
	...
	public  partial class @IfcRelProjectsElement : IfcRelDecomposes, IInstantiableEntity, IIfcRelProjectsElement, IEqualityComparer<@IfcRelProjectsElement>, IEquatable<@IfcRelProjectsElement>
	{
		...
		private IIfcFeatureElementAddition _relatedFeatureElement;
		#endregion
		...
		public IIfcFeatureElementAddition @RelatedFeatureElement 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 4: 
					...
					return;
				case 5: 
					_relatedFeatureElement = (IIfcFeatureElementAddition)(value.EntityVal);
					return;
				default:
