...
namespace Xbim.Ifc4.Interfaces.ProductExtension
{
	...
	public  partial class @IfcRelVoidsElement : IfcRelDecomposes, IInstantiableEntity, IIfcRelVoidsElement, IEqualityComparer<@IfcRelVoidsElement>, IEquatable<@IfcRelVoidsElement>
	{
		...
		private IIfcFeatureElementSubtraction _relatedOpeningElement;
		#endregion
		...
		public IIfcFeatureElementSubtraction @RelatedOpeningElement 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 4: 
					...
					return;
				case 5: 
					_relatedOpeningElement = (IIfcFeatureElementSubtraction)(value.EntityVal);
					return;
				default:
