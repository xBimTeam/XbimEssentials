		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 8: 
					...
					return;
				case 9: 
					_parentBoundary = (IIfcRelSpaceBoundary1stLevel)(value.EntityVal);
					return;
				default:
