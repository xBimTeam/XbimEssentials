...
namespace Xbim.Ifc4.Interfaces.ProductExtension
{
	...
	public  partial class @IfcRelConnectsPortToElement : IfcRelConnects, IInstantiableEntity, IIfcRelConnectsPortToElement, IEqualityComparer<@IfcRelConnectsPortToElement>, IEquatable<@IfcRelConnectsPortToElement>
	{
		...
		public IIfcDistributionElement @RelatedElement 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 3: 
					...
					return;
				case 4: 
					_relatingPort = (IIfcPort)(value.EntityVal);
					return;
				case 5: 
					_relatedElement = (IIfcDistributionElement)(value.EntityVal);
					return;
				default:
