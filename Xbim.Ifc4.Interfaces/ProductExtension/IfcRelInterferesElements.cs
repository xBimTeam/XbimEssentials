...
namespace Xbim.Ifc4.Interfaces.ProductExtension
{
	...
	public  partial class @IfcRelInterferesElements : IfcRelConnects, IInstantiableEntity, IIfcRelInterferesElements, IEqualityComparer<@IfcRelInterferesElements>, IEquatable<@IfcRelInterferesElements>
	{
		...
		private IIfcElement _relatingElement;
		private IIfcElement _relatedElement;
		private IIfcConnectionGeometry _interferenceGeometry;
		...
		public IIfcElement @RelatingElement 
		{ 
			get 
			{
		...
		public IIfcElement @RelatedElement 
		{ 
			get 
			{
		...
		public IIfcConnectionGeometry @InterferenceGeometry 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 3: 
					...
					return;
				case 4: 
					_relatingElement = (IIfcElement)(value.EntityVal);
					return;
				case 5: 
					_relatedElement = (IIfcElement)(value.EntityVal);
					return;
				case 6: 
					_interferenceGeometry = (IIfcConnectionGeometry)(value.EntityVal);
					return;
				case 7: 
