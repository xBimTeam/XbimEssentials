...
namespace Xbim.Ifc4.Interfaces.ProductExtension
{
	...
	public  partial class @IfcRelConnectsWithRealizingElements : IfcRelConnectsElements, IInstantiableEntity, IIfcRelConnectsWithRealizingElements, IEqualityComparer<@IfcRelConnectsWithRealizingElements>, IEquatable<@IfcRelConnectsWithRealizingElements>
	{
		...
		internal IfcRelConnectsWithRealizingElements(IModel model) : base(model) 		{ 
			Model = model; 
			_realizingElements = new ItemSet<IIfcElement>( this, 0 );
		}

		#region Explicit attribute fields
		private ItemSet<IIfcElement> _realizingElements;
		...
		public ItemSet<IIfcElement> @RealizingElements 
		{ 
			get 
			{
		...
		public  override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 6: 
					...
					return;
				case 7: 
					if (_realizingElements == null) _realizingElements = new ItemSet<IIfcElement>( this );
					_realizingElements.InternalAdd((IIfcElement)value.EntityVal);
					return;
				case 8: 
