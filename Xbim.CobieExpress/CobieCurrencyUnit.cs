...
{
	/// <summary>
    /// Readonly interface for CobieCurrencyUnit
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @ICobieCurrencyUnit : ICobiePickValue
	{
...
namespace Xbim.CobieExpress
{
	...
	public  partial class @CobieCurrencyUnit : CobiePickValue, IInstantiableEntity, ICobieCurrencyUnit, IEqualityComparer<@CobieCurrencyUnit>, IEquatable<@CobieCurrencyUnit>
	{
		...
		internal CobieCurrencyUnit(IModel model) : base(model) 		{ 
			Model = model; 
		}
        ...
        public bool Equals(@CobieCurrencyUnit other)
	    {
	        return this == other;
	    }
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @CobieCurrencyUnit
            var root = (@CobieCurrencyUnit)obj;
            return this == root;
        }
