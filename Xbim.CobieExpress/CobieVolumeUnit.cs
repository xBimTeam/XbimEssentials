...
{
	/// <summary>
    /// Readonly interface for CobieVolumeUnit
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @ICobieVolumeUnit : ICobiePickValue
	{
...
namespace Xbim.CobieExpress
{
	...
	public  partial class @CobieVolumeUnit : CobiePickValue, IInstantiableEntity, ICobieVolumeUnit, IEqualityComparer<@CobieVolumeUnit>, IEquatable<@CobieVolumeUnit>
	{
		...
		internal CobieVolumeUnit(IModel model) : base(model) 		{ 
			Model = model; 
		}
        ...
        public bool Equals(@CobieVolumeUnit other)
	    {
	        return this == other;
	    }
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @CobieVolumeUnit
            var root = (@CobieVolumeUnit)obj;
            return this == root;
        }
