...
namespace Xbim.CobieExpress
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @CobieExternalObject : PersistEntity, IInstantiableEntity, ICobieExternalObject, IEquatable<@CobieExternalObject>
	{
		...
		internal CobieExternalObject(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
