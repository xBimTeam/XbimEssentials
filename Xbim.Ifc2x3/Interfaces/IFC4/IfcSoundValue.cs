...
{
	public partial class @IfcSoundValue : IIfcPropertySetDefinition
	{
		...
		{ 
			get
			{
				return Model.Instances.Where<IIfcRelDefinesByProperties>(e => (e.RelatingPropertyDefinition as IfcSoundValue) == this);
			} 
		}
	}
}