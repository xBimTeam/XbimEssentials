...
{
	public partial class @IfcServiceLifeFactor : IIfcPropertySetDefinition
	{
		...
		{ 
			get
			{
				return Model.Instances.Where<IIfcRelDefinesByProperties>(e => (e.RelatingPropertyDefinition as IfcServiceLifeFactor) == this);
			} 
		}
	}
}