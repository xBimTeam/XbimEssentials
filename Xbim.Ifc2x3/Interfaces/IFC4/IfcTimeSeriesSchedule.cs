...
{
	public partial class @IfcTimeSeriesSchedule : IIfcControl
	{
		...
		{ 
			get
			{
				return Model.Instances.Where<IIfcRelAssignsToControl>(e => (e.RelatingControl as IfcTimeSeriesSchedule) == this);
			} 
		}
	}
}