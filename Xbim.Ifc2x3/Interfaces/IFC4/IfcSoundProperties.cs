...
{
	public partial class @IfcSoundProperties : IIfcPropertySetDefinition
	{
		...
		{ 
			get
			{
				return Model.Instances.Where<IIfcRelDefinesByProperties>(e => (e.RelatingPropertyDefinition as IfcSoundProperties) == this);
			} 
		}
	}
}