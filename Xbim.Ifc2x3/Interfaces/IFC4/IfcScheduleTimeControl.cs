...
{
	public partial class @IfcScheduleTimeControl : IIfcControl
	{
		...
		{ 
			get
			{
				return Model.Instances.Where<IIfcRelAssignsToControl>(e => (e.RelatingControl as IfcScheduleTimeControl) == this);
			} 
		}
	}
}