...
{
	public partial class @IfcSpaceThermalLoadProperties : IIfcPropertySetDefinition
	{
		...
		{ 
			get
			{
				return Model.Instances.Where<IIfcRelDefinesByProperties>(e => (e.RelatingPropertyDefinition as IfcSpaceThermalLoadProperties) == this);
			} 
		}
	}
}