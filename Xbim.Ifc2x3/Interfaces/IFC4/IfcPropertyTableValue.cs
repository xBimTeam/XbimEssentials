...
namespace Xbim.Ifc2x3.PropertyResource
{
	public partial class @IfcPropertyTableValue : IIfcPropertyTableValue
	{
		...
		{ 
			get
			{
				...
				return _definingValuesIfc4 ?? (_definingValuesIfc4 = new Common.Collections.ExtendedItemSet<MeasureResource.IfcValue, IIfcValue>(
                    ...
                    DefiningValuesToIfc4, 
                    DefiningValuesToIfc2x3));
			} 
		}
		...
		private IIfcValue DefiningValuesToIfc4 (MeasureResource.IfcValue member)
		{
		...
		private MeasureResource.IfcValue DefiningValuesToIfc2x3 (IIfcValue member){
		...
		//transformation function to convert/cast IFC2x3 data to appear as IFC4
		private IIfcValue DefinedValuesToIfc4 (MeasureResource.IfcValue member)
		{
			if (member is MeasureResource.IfcVolumeMeasure) 
				return new Ifc4.MeasureResource.IfcVolumeMeasure((MeasureResource.IfcVolumeMeasure)member);
			if (member is MeasureResource.IfcTimeMeasure) 
		...
		//transformation function to convert/cast IFC4 data to appear as IFC2x3 if possible
		private MeasureResource.IfcValue DefinedValuesToIfc2x3 (IIfcValue member){
			throw new System.NotImplementedException();
		}
