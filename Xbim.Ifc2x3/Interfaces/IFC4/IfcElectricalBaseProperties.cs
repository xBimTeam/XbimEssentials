...
{
	public partial class @IfcElectricalBaseProperties : IIfcPropertySetDefinition
	{
		...
		{ 
			get
			{
				return Model.Instances.Where<IIfcRelDefinesByProperties>(e => (e.RelatingPropertyDefinition as IfcElectricalBaseProperties) == this);
			} 
		}
	}
}