...
namespace Xbim.Ifc2x3.SharedBldgElements
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.SharedBldgElements.IfcRoof");
		...
		public bool ValidateClause(Where.IfcRoof clause) {
			...
			if (clause == Where.IfcRoof.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcRoof.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
