...
namespace Xbim.Ifc2x3.StructuralElementsDomain
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.StructuralElementsDomain.IfcReinforcingBar");
		...
		public bool ValidateClause(Where.IfcReinforcingBar clause) {
			var retVal = false;
			if (clause == Where.IfcReinforcingBar.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcReinforcingBar.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
		...
		public new IEnumerable<ValidationResult> Validate()
		{
			...
			if (!ValidateClause(Where.IfcReinforcingBar.WR1))
...
namespace Xbim.Ifc2x3.Where
{
	...
	{
		public new static readonly IfcReinforcingBar WR1 = new IfcReinforcingBar();
