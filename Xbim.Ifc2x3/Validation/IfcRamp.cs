...
namespace Xbim.Ifc2x3.SharedBldgElements
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.SharedBldgElements.IfcRamp");
		...
		public bool ValidateClause(Where.IfcRamp clause) {
			...
			if (clause == Where.IfcRamp.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcRamp.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
