...
namespace Xbim.Ifc2x3.HVACDomain
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.HVACDomain.IfcVibrationIsolatorType");
		...
		public bool ValidateClause(Where.IfcVibrationIsolatorType clause) {
			...
			if (clause == Where.IfcVibrationIsolatorType.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcVibrationIsolatorType.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
