...
namespace Xbim.Ifc2x3.HVACDomain
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.HVACDomain.IfcFlowMeterType");
		...
		public bool ValidateClause(Where.IfcFlowMeterType clause) {
			...
			if (clause == Where.IfcFlowMeterType.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcFlowMeterType.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
