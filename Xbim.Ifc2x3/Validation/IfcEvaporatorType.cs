...
namespace Xbim.Ifc2x3.HVACDomain
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.HVACDomain.IfcEvaporatorType");
		...
		public bool ValidateClause(Where.IfcEvaporatorType clause) {
			var retVal = false;
			if (clause == Where.IfcEvaporatorType.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcEvaporatorType.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
		...
		public new IEnumerable<ValidationResult> Validate()
		{
			...
			if (!ValidateClause(Where.IfcEvaporatorType.WR1))
...
namespace Xbim.Ifc2x3.Where
{
	...
	{
		public new static readonly IfcEvaporatorType WR1 = new IfcEvaporatorType();
