...
namespace Xbim.Ifc2x3.HVACDomain
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.HVACDomain.IfcSpaceHeaterType");
		...
		public bool ValidateClause(Where.IfcSpaceHeaterType clause) {
			var retVal = false;
			if (clause == Where.IfcSpaceHeaterType.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcSpaceHeaterType.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
		...
		public new IEnumerable<ValidationResult> Validate()
		{
			...
			if (!ValidateClause(Where.IfcSpaceHeaterType.WR1))
...
namespace Xbim.Ifc2x3.Where
{
	...
	{
		public new static readonly IfcSpaceHeaterType WR1 = new IfcSpaceHeaterType();
