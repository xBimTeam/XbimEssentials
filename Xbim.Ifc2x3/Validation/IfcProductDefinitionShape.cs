...
namespace Xbim.Ifc2x3.RepresentationResource
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.RepresentationResource.IfcProductDefinitionShape");
		...
		public bool ValidateClause(Where.IfcProductDefinitionShape clause) {
			...
			if (clause == Where.IfcProductDefinitionShape.WR11) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcProductDefinitionShape.WR11' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
