...
namespace Xbim.Ifc2x3.HVACDomain
{
	public partial class IfcFilterType : IExpressValidatable
	{
		...
		public bool ValidateClause(Where.IfcFilterType clause) {
			var retVal = false;
			if (clause == Where.IfcFilterType.WR1) {
				try {
					...
					ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.HVACDomain.IfcFilterType");
					Log.Error(string.Format("Exception thrown evaluating where-clause 'IfcFilterType.WR1' for #{0}.",EntityLabel), ex);
				}
				return retVal;
			}
		...
		public override IEnumerable<ValidationResult> Validate()
		{
			...
			if (!ValidateClause(Where.IfcFilterType.WR1))
...
namespace Xbim.Ifc2x3.Where
{
	...
	{
		public new static readonly IfcFilterType WR1 = new IfcFilterType();
