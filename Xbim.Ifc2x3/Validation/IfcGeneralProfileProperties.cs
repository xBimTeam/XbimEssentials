...
namespace Xbim.Ifc2x3.ProfilePropertyResource
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.ProfilePropertyResource.IfcGeneralProfileProperties");
		...
		public bool ValidateClause(Where.IfcGeneralProfileProperties clause) {
			...
			if (clause == Where.IfcGeneralProfileProperties.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcGeneralProfileProperties.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
