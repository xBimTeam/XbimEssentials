...
namespace Xbim.Ifc2x3.Kernel
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.Kernel.IfcObject");
		...
		public bool ValidateClause(Where.IfcObject clause) {
			...
			if (clause == Where.IfcObject.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcObject.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
