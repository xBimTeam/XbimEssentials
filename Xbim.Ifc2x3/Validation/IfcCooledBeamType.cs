...
namespace Xbim.Ifc2x3.HVACDomain
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.HVACDomain.IfcCooledBeamType");
		...
		public bool ValidateClause(Where.IfcCooledBeamType clause) {
			...
			if (clause == Where.IfcCooledBeamType.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcCooledBeamType.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
