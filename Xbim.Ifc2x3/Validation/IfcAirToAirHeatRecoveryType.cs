...
namespace Xbim.Ifc2x3.HVACDomain
{
	...
	{
		private static readonly ILog Log = LogManager.GetLogger("Xbim.Ifc2x3.HVACDomain.IfcAirToAirHeatRecoveryType");
		...
		public bool ValidateClause(Where.IfcAirToAirHeatRecoveryType clause) {
			...
			if (clause == Where.IfcAirToAirHeatRecoveryType.WR1) {
				try {
					...
					Log.Error($"Exception thrown evaluating where-clause 'IfcAirToAirHeatRecoveryType.WR1' for #{EntityLabel}.", ex);
				}
				return retVal;
			}
