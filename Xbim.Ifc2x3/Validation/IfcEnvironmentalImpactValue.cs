...
namespace Xbim.Ifc2x3.CostResource
{
	public partial class IfcEnvironmentalImpactValue : IExpressValidatable
	{
		...
		public bool ValidateClause(Where.IfcEnvironmentalImpactValue clause) {
			var retVal = false;
			if (clause == Where.IfcEnvironmentalImpactValue.WR1) {
				try {
		...
		public new IEnumerable<ValidationResult> Validate()
		{
			...
			if (!ValidateClause(Where.IfcEnvironmentalImpactValue.WR1))
...
namespace Xbim.Ifc2x3.Where
{
	...
	{
		public new static readonly IfcEnvironmentalImpactValue WR1 = new IfcEnvironmentalImpactValue();
		protected IfcEnvironmentalImpactValue() {}
	}
}
