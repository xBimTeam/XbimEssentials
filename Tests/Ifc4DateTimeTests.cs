...
namespace Xbim.Essentials.Tests
{
    ...
    public class Ifc4DateTimeTests
    {
        ...
        public void DateTimeTest()
        {
            ...
            IfcDate date = dt;
            Assert.AreEqual("2016-03-31", date.ToString());
            ...
            Assert.AreEqual("2016-03-31T10:54:02.0000000", dateTime.ToString());
            ...
            IfcTime time = dt;
            Assert.AreEqual("10:54:02.0000000", time.ToString());
            ...
            Assert.AreEqual("P9DT5H32M45.012S", duration.ToString());
